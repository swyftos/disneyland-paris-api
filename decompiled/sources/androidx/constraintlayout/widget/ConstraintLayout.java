...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            boolean z9 = z5 && constraintWidget.mDimensionRatio > BitmapDescriptorFactory.HUE_RED;
            boolean z10 = z6 && constraintWidget.mDimensionRatio > BitmapDescriptorFactory.HUE_RED;
            if (view == null) {
                return;
            }
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3) {
        ...
        constraintWidgetContainer.measure(i, mode, i5, mode2, i6, this.mLastMeasureWidth, this.mLastMeasureHeight, iMax4, iMax);
    }
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(LayoutParams layoutParams) {
            ...
            this.dimensionRatioValue = BitmapDescriptorFactory.HUE_RED;
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (i2) {
                    ...
                    case 35:
                        this.matchConstraintPercentWidth = Math.max(BitmapDescriptorFactory.HUE_RED, typedArrayObtainStyledAttributes.getFloat(index, this.matchConstraintPercentWidth));
                    ...
                    case 38:
                        this.matchConstraintPercentHeight = Math.max(BitmapDescriptorFactory.HUE_RED, typedArrayObtainStyledAttributes.getFloat(index, this.matchConstraintPercentHeight));
