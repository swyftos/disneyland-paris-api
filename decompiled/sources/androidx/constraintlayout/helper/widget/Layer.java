...
public class Layer extends ConstraintHelper {
    ...
    public Layer(Context context) {
        ...
        this.mViews = null;
        this.mShiftX = BitmapDescriptorFactory.HUE_RED;
        this.mShiftY = BitmapDescriptorFactory.HUE_RED;
    }
        ...
        if (this.mApplyVisibilityOnAttach || this.mApplyElevationOnAttach) {
            ...
            for (int i = 0; i < this.mCount; i++) {
                ...
                if (viewById != null) {
                    ...
                    if (this.mApplyElevationOnAttach && elevation > BitmapDescriptorFactory.HUE_RED) {
