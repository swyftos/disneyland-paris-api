...
public class VelocityMatrix {
    ...
    public void clear() {
        this.mDRotate = BitmapDescriptorFactory.HUE_RED;
        this.mDTranslateY = BitmapDescriptorFactory.HUE_RED;
        this.mDTranslateX = BitmapDescriptorFactory.HUE_RED;
        this.mDScaleY = BitmapDescriptorFactory.HUE_RED;
        this.mDScaleX = BitmapDescriptorFactory.HUE_RED;
    }
