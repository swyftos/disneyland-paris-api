...
public class Transition implements TypedValues {
    ...
    private float mStagger = BitmapDescriptorFactory.HUE_RED;
    ...
    public KeyPosition findPreviousPosition(String str, int i) {
        ...
        while (i >= 0) {
            HashMap map = (HashMap) this.keyPositions.get(Integer.valueOf(i));
    ...
    public int getNumberKeyPositions(WidgetFrame widgetFrame) {
        ...
        for (int i2 = 0; i2 <= 100; i2++) {
            HashMap map = (HashMap) this.keyPositions.get(Integer.valueOf(i2));
    ...
    public void interpolate(int i, int i2, float f) {
        ...
        while (it.hasNext()) {
            ((WidgetState) this.state.get((String) it.next())).interpolate(i, i2, f, this);
        }
    }
    ...
    public float[] getPath(String str) {
        WidgetState widgetState = (WidgetState) this.state.get(str);
        float[] fArr = new float[Currencies.CAD];
