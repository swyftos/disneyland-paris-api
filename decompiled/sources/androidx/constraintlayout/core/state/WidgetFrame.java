...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        float f9 = widgetFrame3.visibility == 4 ? BitmapDescriptorFactory.HUE_RED : f4;
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindNextPosition != null) {
                ...
                i17 = (int) (keyPositionFindNextPosition.y * i9);
        ...
        widgetFrame.rotationX = interpolate(widgetFrame2.rotationX, widgetFrame3.rotationX, BitmapDescriptorFactory.HUE_RED, f);
        widgetFrame.rotationY = interpolate(widgetFrame2.rotationY, widgetFrame3.rotationY, BitmapDescriptorFactory.HUE_RED, f);
        widgetFrame.rotationZ = interpolate(widgetFrame2.rotationZ, widgetFrame3.rotationZ, BitmapDescriptorFactory.HUE_RED, f);
        ...
        widgetFrame.translationX = interpolate(widgetFrame2.translationX, widgetFrame3.translationX, BitmapDescriptorFactory.HUE_RED, f);
        widgetFrame.translationY = interpolate(widgetFrame2.translationY, widgetFrame3.translationY, BitmapDescriptorFactory.HUE_RED, f);
        widgetFrame.translationZ = interpolate(widgetFrame2.translationZ, widgetFrame3.translationZ, BitmapDescriptorFactory.HUE_RED, f);
        ...
        for (String str : setKeySet) {
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    customVariable3.setValue(Float.valueOf(interpolate(customVariable.getValueToInterpolate(), customVariable2.getValueToInterpolate(), BitmapDescriptorFactory.HUE_RED, f)));
                } else {
                    ...
                    for (int i25 = 0; i25 < iNumberOfInterpolatedValues; i25++) {
                        fArr[i25] = interpolate(fArr[i25], fArr2[i25], BitmapDescriptorFactory.HUE_RED, f);
