...
public class ConstraintReference implements Reference {
    ...
    */
    ...
    public void apply() {
        ...
        HashMap map = this.mCustomColors;
        if (map != null) {
            for (String str : map.keySet()) {
                this.mConstraintWidget.frame.setCustomAttribute(str, TypedValues.Custom.TYPE_COLOR, ((Integer) this.mCustomColors.get(str)).intValue());
            }
        }
        HashMap map2 = this.mCustomFloats;
        if (map2 != null) {
