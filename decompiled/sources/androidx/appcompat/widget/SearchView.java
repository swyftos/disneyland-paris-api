...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(imageView4, onClickListener);
        InstrumentationCallbacks.setOnClickListenerCalled(searchAutoComplete, onClickListener);
        ...
        InstrumentationCallbacks.setOnFocusChangeListenerCalled(searchAutoComplete, new View.OnFocusChangeListener() { // from class: androidx.appcompat.widget.SearchView.3
