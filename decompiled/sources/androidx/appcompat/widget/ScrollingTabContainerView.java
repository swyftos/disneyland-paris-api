...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void animateToVisibility(int i) {
        ...
        ViewPropertyAnimator viewPropertyAnimatorAlpha2 = animate().alpha(BitmapDescriptorFactory.HUE_RED);
    ...
    TabView createTabView(ActionBar.Tab tab, boolean z) {
        ...
        if (z) {
            ...
            InstrumentationCallbacks.setOnClickListenerCalled(tabView, this.mTabClickListener);
        }
        return tabView;
    }
