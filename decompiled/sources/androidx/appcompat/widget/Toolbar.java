...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public void setNavigationOnClickListener(View.OnClickListener onClickListener) {
        ensureNavButtonView();
        InstrumentationCallbacks.setOnClickListenerCalled(this.mNavButtonView, onClickListener);
    }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            layoutParamsGenerateDefaultLayoutParams.gravity = (this.mButtonGravity & SyslogConstants.LOG_ALERT) | GravityCompat.END;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = (this.mButtonGravity & SyslogConstants.LOG_ALERT) | GravityCompat.START;
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            InstrumentationCallbacks.setOnClickListenerCalled(this.mCollapseButtonView, new View.OnClickListener() { // from class: androidx.appcompat.widget.Toolbar.4
    ...
    */
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & SyslogConstants.LOG_ALERT;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = (toolbar4.mButtonGravity & SyslogConstants.LOG_ALERT) | GravityCompat.START;
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
