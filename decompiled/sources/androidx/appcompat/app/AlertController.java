...
class AlertController {
    ...
    private void setupButtons(ViewGroup viewGroup) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(button, this.mButtonHandler);
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(button2, this.mButtonHandler);
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(button3, this.mButtonHandler);
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    checkedItemAdapter = new ArrayAdapter(this.mContext, alertController.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
            ...
            if (this.mOnClickListener != null) {
                InstrumentationCallbacks.setOnItemClickListenerCalled(recycleListView, new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                ...
                InstrumentationCallbacks.setOnItemClickListenerCalled(recycleListView, new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    @Override // android.widget.AdapterView.OnItemClickListener
                    public void onItemClick(AdapterView adapterView, View view, int i3, long j) {
                        boolean[] zArr = AlertParams.this.mCheckedItems;
                        if (zArr != null) {
