...
abstract class ViewUtils {
    ...
    static final Property TRANSITION_ALPHA = new Property(Float.class, "translationAlpha") { // from class: androidx.transition.ViewUtils.1
    ...
    static final Property CLIP_BOUNDS = new Property(Rect.class, "clipBounds") { // from class: androidx.transition.ViewUtils.2
        @Override // android.util.Property
