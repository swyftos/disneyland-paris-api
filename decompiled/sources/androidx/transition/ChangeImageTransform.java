...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator NULL_MATRIX_EVALUATOR = new TypeEvaluator() { // from class: androidx.transition.ChangeImageTransform.1
        @Override // android.animation.TypeEvaluator
        public Matrix evaluate(float f, Matrix matrix, Matrix matrix2) {
            return null;
        }
    };
    private static final Property ANIMATED_TRANSFORM_PROPERTY = new Property(Matrix.class, "animatedTransform") { // from class: androidx.transition.ChangeImageTransform.2
