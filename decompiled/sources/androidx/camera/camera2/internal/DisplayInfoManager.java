...
public class DisplayInfoManager {
    ...
    private static final Size ABNORMAL_DISPLAY_SIZE_THRESHOLD = new Size(Currencies.GTQ, PsExtractor.VIDEO_STREAM_MASK);
    private static final Size FALLBACK_DISPLAY_SIZE = new Size(640, Currencies.MUR);
