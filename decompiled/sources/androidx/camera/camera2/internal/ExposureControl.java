...
public class ExposureControl {
    ...
    ListenableFuture setExposureCompensationIndex(final int i) {
        ...
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda0
