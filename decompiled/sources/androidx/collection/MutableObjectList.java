...
public final class MutableObjectList<E> extends ObjectList<E> {
    ...
    public final void add(@IntRange(from = 0) int index, E element) {
        ...
        int i2 = this._size;
        if (index != i2) {
            ArraysKt.copyInto(objArr, objArr, index + 1, index, i2);
        }
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull E[] elements) {
        ...
        int i2 = this._size;
        if (index != i2) {
            ArraysKt.copyInto(objArr, objArr, elements.length + index, index, i2);
        }
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull ObjectList<E> elements) {
        ...
        int i = this._size;
        if (index != i) {
            ArraysKt.copyInto(objArr, objArr, elements._size + index, index, i);
        }
    ...
    public final void removeIf(@NotNull Function1<? super E, Boolean> predicate) {
        ...
        Object[] objArr = this.content;
        int i2 = 0;
        kotlin.ranges.IntRange intRangeUntil = RangesKt.until(0, i);
    ...
    public final void removeRange(@IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        ...
        if (end != start) {
            if (end < i) {
                Object[] objArr = this.content;
                ArraysKt.copyInto(objArr, objArr, start, end, i);
            }
            int i2 = this._size;
            int i3 = i2 - (end - start);
            ArraysKt.fill(this.content, (Object) null, i3, i2);
            this._size = i3;
        }
    }
    ...
    private static final class MutableObjectListIterator implements ListIterator, KMutableListIterator {
    ...
    private static final class ObjectListMutableList implements List, KMutableList {
