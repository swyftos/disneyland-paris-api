...
public final class MutableFloatList extends FloatList {
    ...
    public final void add(@IntRange(from = 0) int index, float element) {
        ...
        int i2 = this._size;
        if (index != i2) {
            ArraysKt.copyInto(fArr, fArr, index + 1, index, i2);
        }
        fArr[index] = element;
        this._size++;
    }
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull float[] elements) {
        ...
        int i2 = this._size;
        if (index != i2) {
            ArraysKt.copyInto(fArr, fArr, elements.length + index, index, i2);
        }
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull FloatList elements) {
        ...
        int i = this._size;
        if (index != i) {
            ArraysKt.copyInto(fArr, fArr, elements._size + index, index, i);
        }
    ...
    public final void removeRange(@IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        ...
        if (end >= start) {
            if (end != start) {
                if (end < i) {
                    float[] fArr = this.content;
                    ArraysKt.copyInto(fArr, fArr, start, end, i);
                }
