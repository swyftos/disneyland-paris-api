...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    public ActivityResultCallerLauncher(@NotNull ActivityResultLauncher<I> launcher, @NotNull ActivityResultContract<I, O> callerContract, I i) {
        ...
        this.callerInput = i;
        this.resultContract = LazyKt.lazy(new Function0() { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
            {
                super(0);
            }
            ...
            public final AnonymousClass1 invoke() {
                final ActivityResultCallerLauncher activityResultCallerLauncher = this.this$0;
