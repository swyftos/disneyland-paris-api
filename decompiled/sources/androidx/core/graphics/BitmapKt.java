...
public final class BitmapKt {
    ...
    public static final boolean contains(@NotNull Bitmap bitmap, @NotNull PointF pointF) {
        float f = pointF.x;
        if (f >= BitmapDescriptorFactory.HUE_RED && f < bitmap.getWidth()) {
            float f2 = pointF.y;
            if (f2 >= BitmapDescriptorFactory.HUE_RED && f2 < bitmap.getHeight()) {
                return true;
            }
        }
        return false;
