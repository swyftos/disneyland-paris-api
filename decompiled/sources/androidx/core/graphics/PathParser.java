            ...
            while (i4 < fArr2.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        int i30 = i4 + 6;
                        i3 = i4;
                        drawArc(path, f15, f16, fArr2[i29] + f15, fArr2[i30] + f16, fArr2[i4], fArr2[i4 + 1], fArr2[i4 + 2], fArr2[i4 + 3] != BitmapDescriptorFactory.HUE_RED, fArr2[i4 + 4] != BitmapDescriptorFactory.HUE_RED);
                        f15 += fArr2[i29];
                        f16 += fArr2[i30];
                    }
                    i4 = i3 + i2;
                    ...
                    int i31 = i3 + 5;
                    int i32 = i3 + 6;
                    drawArc(path, f15, f16, fArr2[i31], fArr2[i32], fArr2[i3], fArr2[i3 + 1], fArr2[i3 + 2], fArr2[i3 + 3] != BitmapDescriptorFactory.HUE_RED, fArr2[i3 + 4] != BitmapDescriptorFactory.HUE_RED);
                    f15 = fArr2[i31];
                    f16 = fArr2[i32];
                }
                f12 = f16;
