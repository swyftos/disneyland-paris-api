...
public final class ColorUtils {
    ...
    public static void XYZToLAB(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 95.047d) double d, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) double d2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 108.883d) double d3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) double d, @FloatRange(from = -128.0d, to = 127.0d) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3, double[] dArr) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 95.047d) double d, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) double d2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 108.883d) double d3) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) double d, @FloatRange(from = -128.0d, to = 127.0d) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
        float f2 = 1.0f - f;
    ...
    public static void blendLAB(double[] dArr, double[] dArr2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) double d, double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    @ColorInt
    public static int M3HCTToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 360.0d, toInclusive = false) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 100.0d) float f3) {
