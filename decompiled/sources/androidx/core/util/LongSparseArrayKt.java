...
public final class LongSparseArrayKt {
    ...
    public static final class C05671<T> implements Iterator<T>, KMappedMarker {
        ...
        C05671(LongSparseArray longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(@NotNull LongSparseArray<T> longSparseArray) {
        return new C05671(longSparseArray);
    }
}
