...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            private Bundle toBundle() {
                ...
                if (uri != null) {
                    bundle.putParcelable(ReactNativeBlobUtilConst.DATA_ENCODE_URI, uri);
                }
                Bundle bundle2 = this.mExtras;
                if (bundle2 != null) {
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey("time")) {
                        ...
                        if (bundle.containsKey("type") && bundle.containsKey(ReactNativeBlobUtilConst.DATA_ENCODE_URI)) {
                            message.setData(bundle.getString("type"), (Uri) bundle.getParcelable(ReactNativeBlobUtilConst.DATA_ENCODE_URI));
                        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private static void getTextsFromViewTraversal(View view, ArrayList arrayList) {
            CharSequence text;
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m206clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            if (bundle != null) {
                ...
                this.mBackground = (Bitmap) bundle.getParcelable(AppStateModule.APP_STATE_BACKGROUND);
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m207clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                ...
                bundle.putParcelable("remote_input", Api20Impl.castToParcelable(Api20Impl.build(builderCreateBuilder)));
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i2 = 0; i2 < remoteInputs.length; i2++) {
                ...
                remoteInputArr2[i2] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Api29Impl.getEditChoicesBeforeSending(remoteInput), Api20Impl.getExtras(remoteInput), null);
            }
