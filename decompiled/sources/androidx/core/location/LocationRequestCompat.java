...
public final class LocationRequestCompat {
    ...
    public static final class Builder {
        ...
        public Builder(long j) {
            ...
            this.mMinUpdateDistanceMeters = BitmapDescriptorFactory.HUE_RED;
        ...
        public Builder setMinUpdateDistanceMeters(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 3.4028234663852886E38d) float f) {
            this.mMinUpdateDistanceMeters = f;
            this.mMinUpdateDistanceMeters = Preconditions.checkArgumentInRange(f, BitmapDescriptorFactory.HUE_RED, Float.MAX_VALUE, "minUpdateDistanceMeters");
            return this;
        }
