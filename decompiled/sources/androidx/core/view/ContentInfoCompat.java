...
public final class ContentInfoCompat {
    ...
    public Pair<ContentInfoCompat, ContentInfoCompat> partition(Predicate<ClipData.Item> predicate) {
        ...
        Pair pairPartition = partition(clip, predicate);
    ...
    private static final class Api31Impl {
        public static Pair partition(ContentInfo contentInfo, final java.util.function.Predicate predicate) {
            ...
            Pair pairPartition = ContentInfoCompat.partition(clip, new Predicate() { // from class: androidx.core.view.ContentInfoCompat$Api31Impl$$ExternalSyntheticLambda0
