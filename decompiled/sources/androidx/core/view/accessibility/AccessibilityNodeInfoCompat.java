...
public class AccessibilityNodeInfoCompat {
    ...
    public boolean isGranularScrollingSupported() {
        return getBooleanProperty(AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
    }

    public void setGranularScrollingSupported(boolean z) {
        setBooleanProperty(AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL, z);
    }
