...
public final class FlacStreamMetadata {
    ...
    private static Metadata concatenateVorbisMetadata(List list, List list2) {
        Metadata vorbisComments = VorbisUtil.parseVorbisComments(list);
        if (vorbisComments == null && list2.isEmpty()) {
            return null;
        }
        return new Metadata((List<? extends Metadata.Entry>) list2).copyWithAppendedEntriesFrom(vorbisComments);
    }
}
