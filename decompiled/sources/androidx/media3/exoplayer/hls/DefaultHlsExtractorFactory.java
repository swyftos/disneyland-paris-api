...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    private static TsExtractor createTsExtractor(int i, boolean z, Format format, List list, TimestampAdjuster timestampAdjuster, SubtitleParser.Factory factory, boolean z2) {
        int i2;
        int i3 = i | 16;
        if (list != null) {
            i3 = i | 48;
    ...
    private static FragmentedMp4Extractor createFragmentedMp4Extractor(SubtitleParser.Factory factory, boolean z, TimestampAdjuster timestampAdjuster, Format format, List list) {
