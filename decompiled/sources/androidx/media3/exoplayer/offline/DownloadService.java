...
public abstract class DownloadService extends Service {
    ...
    private static final HashMap downloadManagerHelpers = new HashMap();
    ...
    public void onCreate() {
        ...
        Class<?> cls = getClass();
        HashMap map = downloadManagerHelpers;
    ...
    public int onStartCommand(@Nullable Intent intent, int i, int i2) {
        ...
        if (intent != null) {
            ...
            this.startedInForeground |= intent.getBooleanExtra(KEY_FOREGROUND, false) || "androidx.media3.exoplayer.downloadService.action.RESTART".equals(action);
        } else {
            action = null;
            stringExtra = null;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void notifyDownloads(List list) {
    ...
    private static Intent getIntent(Context context, Class cls, String str, boolean z) {
    ...
    final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (!this.notificationDisplayed) {
                ...
                ((NotificationManager) DownloadService.this.getSystemService(TransferService.INTENT_KEY_NOTIFICATION)).notify(this.notificationId, foregroundNotification);
            }
    ...
    static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public boolean updateScheduler() {
            ...
            if (this.scheduler.schedule(requirements, this.context.getPackageName(), "androidx.media3.exoplayer.downloadService.action.RESTART")) {
        ...
        private void restartService() {
            if (this.foregroundAllowed) {
                try {
                    Util.startForegroundService(this.context, DownloadService.getIntent(this.context, this.serviceClass, "androidx.media3.exoplayer.downloadService.action.RESTART"));
                    return;
