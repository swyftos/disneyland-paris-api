...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public PlaybackStats getCombinedPlaybackStats() {
        ...
        Iterator it = this.playbackStatsTrackers.values().iterator();
        while (it.hasNext()) {
    ...
    public PlaybackStats getPlaybackStats() {
        ...
        PlaybackStatsTracker playbackStatsTracker = activeSessionId == null ? null : (PlaybackStatsTracker) this.playbackStatsTrackers.get(activeSessionId);
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ((PlaybackStatsTracker) Assertions.checkNotNull((PlaybackStatsTracker) this.playbackStatsTrackers.get(str))).onForeground();
    }

    @Override // androidx.media3.exoplayer.analytics.PlaybackSessionManager.Listener
    public void onAdPlaybackStarted(AnalyticsListener.EventTime eventTime, String str, String str2) {
        ((PlaybackStatsTracker) Assertions.checkNotNull((PlaybackStatsTracker) this.playbackStatsTrackers.get(str))).onInterruptedByAd();
    }

    @Override // androidx.media3.exoplayer.analytics.PlaybackSessionManager.Listener
    public void onSessionFinished(AnalyticsListener.EventTime eventTime, String str, boolean z) {
        PlaybackStatsTracker playbackStatsTracker = (PlaybackStatsTracker) Assertions.checkNotNull((PlaybackStatsTracker) this.playbackStatsTrackers.remove(str));
        AnalyticsListener.EventTime eventTime2 = (AnalyticsListener.EventTime) Assertions.checkNotNull((AnalyticsListener.EventTime) this.sessionStartEventTimes.remove(str));
    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        for (String str : this.playbackStatsTrackers.keySet()) {
            Pair pairFindBestEventTime = findBestEventTime(events, str);
    ...
    private Pair findBestEventTime(AnalyticsListener.Events events, String str) {
