...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Parcelable.Creator<PlaybackStateCompat> CREATOR = new Parcelable.Creator() { // from class: androidx.media3.session.legacy.PlaybackStateCompat.1
    ...
    public static final class CustomAction implements Parcelable {
        public static final Parcelable.Creator<CustomAction> CREATOR = new Parcelable.Creator() { // from class: androidx.media3.session.legacy.PlaybackStateCompat.CustomAction.1
            @Override // android.os.Parcelable.Creator
    ...
    private static class Api21Impl {
        ...
        @DoNotInline
        static void setErrorMessage(PlaybackState.Builder builder, @Nullable CharSequence charSequence) {
        ...
        @DoNotInline
        static void setExtras(PlaybackState.CustomAction.Builder builder, @Nullable Bundle bundle) {
    ...
    private static class Api22Impl {
        @DoNotInline
        static void setExtras(PlaybackState.Builder builder, @Nullable Bundle bundle) {
            builder.setExtras(bundle);
        }
