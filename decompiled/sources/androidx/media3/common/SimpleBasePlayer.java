...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        public static final class Builder {
            ...
            private ImmutableList playlist;
    ...
    private static final class PlaylistTimeline extends Timeline {
        ...
        public PlaylistTimeline(ImmutableList immutableList) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                MediaItemData mediaItemData2 = (MediaItemData) immutableList.get(i3);
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda42
    ...
    private void setMediaItemsInternal(final List list, final int i, final long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda38
            @Override // com.google.common.base.Supplier
            public final Object get() {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda51
            @Override // com.google.common.base.Supplier
            public final Object get() {
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda55
            @Override // com.google.common.base.Supplier
            public final Object get() {
    ...
    public final void setRepeatMode(final int i) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda44
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda39
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda43
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setVolume(final float f) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda45
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i, int i2) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, i2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda40
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void increaseDeviceVolume(int i) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda37
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void decreaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda41
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    @ForOverride
    protected ListenableFuture<?> handleSetVolume(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
    ...
    private void updateStateForPendingOperation(final ListenableFuture listenableFuture, Supplier supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda63
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$updateStateForPendingOperation$62(listenableFuture);
            }
        }, new Executor() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda64
    ...
    private static int getTimelineChangeReason(List list, List list2) {
        ...
        while (true) {
            ...
            Object obj = ((MediaItemData) list.get(i)).uid;
            Object obj2 = ((MediaItemData) list2.get(i)).uid;
    ...
    private static int getMediaItemIndexInNewPlaylist(List list, Timeline timeline, int i, Timeline.Period period) {
        if (!list.isEmpty()) {
            Object periodUid = ((MediaItemData) list.get(i)).getPeriodUid(0);
    ...
    private static State getStateWithNewPlaylist(State state, List list, Timeline.Period period) {
    ...
    private static State getStateWithNewPlaylistAndPosition(State state, List list, int i, long j) {
        State.Builder builderBuildUpon = state.buildUpon();
        builderBuildUpon.setPlaylist(list);
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j, List list, int i, long j2, boolean z) {
        ...
        if (!list.isEmpty() && j2 == C.TIME_UNSET) {
            j2 = Util.usToMs(((MediaItemData) list.get(i)).defaultPositionUs);
        }
        boolean z3 = state.playlist.isEmpty() || list.isEmpty();
        if (!z3 && !state.playlist.get(getCurrentMediaItemIndexInternal(state)).uid.equals(((MediaItemData) list.get(i)).uid)) {
            z2 = true;
        }
