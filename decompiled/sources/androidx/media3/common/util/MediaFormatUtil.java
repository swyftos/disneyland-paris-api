...
public final class MediaFormatUtil {
    ...
    public static MediaFormat createMediaFormatFromFormat(Format format) {
        ...
        maybeSetInteger(mediaFormat, TCVideoEventPropertiesNames.TCV_BITRATE, format.bitrate);
        ...
        maybeSetString(mediaFormat, TCEventPropertiesNames.TCD_LANGUAGE, format.language);
