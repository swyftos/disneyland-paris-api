...
public final class GlProgram {
    ...
    private final Map uniformByName;
    ...
    public void setBufferAttribute(String str, float[] fArr, int i) {
        ((Attribute) Assertions.checkNotNull((Attribute) this.attributeByName.get(str))).setBuffer(fArr, i);
    }

    public void setSamplerTexIdUniform(String str, int i, int i2) {
        ((Uniform) Assertions.checkNotNull((Uniform) this.uniformByName.get(str))).setSamplerTexId(i, i2);
    }

    public void setIntUniform(String str, int i) {
        ((Uniform) Assertions.checkNotNull((Uniform) this.uniformByName.get(str))).setInt(i);
    }

    public void setIntsUniform(String str, int[] iArr) {
        ((Uniform) Assertions.checkNotNull((Uniform) this.uniformByName.get(str))).setInts(iArr);
    }

    public void setFloatUniform(String str, float f) {
        ((Uniform) Assertions.checkNotNull((Uniform) this.uniformByName.get(str))).setFloat(f);
    }

    public void setFloatsUniform(String str, float[] fArr) {
        ((Uniform) Assertions.checkNotNull((Uniform) this.uniformByName.get(str))).setFloats(fArr);
    }

    public void setFloatsUniformIfPresent(String str, float[] fArr) {
        Uniform uniform = (Uniform) this.uniformByName.get(str);
        if (uniform == null) {
            return;
        }
