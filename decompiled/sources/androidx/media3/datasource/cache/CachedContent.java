...
final class CachedContent {
    ...
    public SimpleCacheSpan getSpan(long j, long j2) {
        ...
        SimpleCacheSpan simpleCacheSpan = (SimpleCacheSpan) this.cachedSpans.floor(simpleCacheSpanCreateLookup);
        if (simpleCacheSpan != null && simpleCacheSpan.position + simpleCacheSpan.length > j) {
            return simpleCacheSpan;
        }
        SimpleCacheSpan simpleCacheSpan2 = (SimpleCacheSpan) this.cachedSpans.ceiling(simpleCacheSpanCreateLookup);
