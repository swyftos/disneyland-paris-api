...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.SavedState.1
    ...
    */
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setStartEndTrim(BitmapDescriptorFactory.HUE_RED, Math.min(MAX_PROGRESS_ANGLE, fMax * MAX_PROGRESS_ANGLE));
