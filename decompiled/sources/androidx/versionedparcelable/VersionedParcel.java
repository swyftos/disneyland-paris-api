...
public abstract class VersionedParcel {
    ...
    private void writeCollection(Collection collection, int i) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        setOutputField(i);
        writeCollection(collection);
    }

    private void writeCollection(Collection collection) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        if (collection == null) {
            writeInt(-1);
        }
