...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    public SlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mOnFoldingFeatureChangeListener = new FoldingFeatureObserver.OnFoldingFeatureChangeListener() { // from class: androidx.slidingpanelayout.widget.SlidingPaneLayout.1
            ...
            public void onFoldingFeatureChange(FoldingFeature foldingFeature) {
                ...
                changeBounds.setInterpolator(PathInterpolatorCompat.create(0.2f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f));
    ...
    protected void onDetachedFromWindow() {
        ...
        if (this.mPostedRunnables.size() > 0) {
            SlidingPaneLayout$$ExternalSyntheticThrowCCEIfNotNull0.m(this.mPostedRunnables.get(0));
            throw null;
        }
  ...
  0x0086: PHI (r15v5 float) = (r15v1 float), (r15v6 float) binds: [B:19:0x007d, B:21:0x0082] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private static int measureChildHeight(View view, int i, int i2) {
        ...
        if (((ViewGroup.MarginLayoutParams) layoutParams).width == 0 && layoutParams.weight > BitmapDescriptorFactory.HUE_RED) {
    ...
    public boolean isOpen() {
        return !this.mCanSlide || this.mSlideOffset == BitmapDescriptorFactory.HUE_RED;
    }
    ...
    boolean isDimmed(View view) {
        ...
        return this.mCanSlide && ((LayoutParams) view.getLayoutParams()).dimWhenOffset && this.mSlideOffset > BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.weight = typedArrayObtainStyledAttributes.getFloat(0, BitmapDescriptorFactory.HUE_RED);
