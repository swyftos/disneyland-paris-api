...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private int releaseHorizontalGlow(int i, float f) {
        ...
        if (edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != BitmapDescriptorFactory.HUE_RED) {
            if (canScrollHorizontally(-1)) {
                this.mLeftGlow.onRelease();
            } else {
                float f3 = -EdgeEffectCompat.onPullDistance(this.mLeftGlow, -width, 1.0f - height);
                if (EdgeEffectCompat.getDistance(this.mLeftGlow) == BitmapDescriptorFactory.HUE_RED) {
                    this.mLeftGlow.onRelease();
                }
                f2 = f3;
            }
            ...
            if (edgeEffect2 != null && EdgeEffectCompat.getDistance(edgeEffect2) != BitmapDescriptorFactory.HUE_RED) {
                if (canScrollHorizontally(1)) {
                    this.mRightGlow.onRelease();
                } else {
                    float fOnPullDistance = EdgeEffectCompat.onPullDistance(this.mRightGlow, width, height);
                    if (EdgeEffectCompat.getDistance(this.mRightGlow) == BitmapDescriptorFactory.HUE_RED) {
                        this.mRightGlow.onRelease();
                    }
                    f2 = fOnPullDistance;
                }
    ...
    private int releaseVerticalGlow(int i, float f) {
        ...
        if (edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != BitmapDescriptorFactory.HUE_RED) {
            if (canScrollVertically(-1)) {
                ...
                if (EdgeEffectCompat.getDistance(this.mTopGlow) == BitmapDescriptorFactory.HUE_RED) {
                    this.mTopGlow.onRelease();
                }
                f2 = f3;
            }
            ...
            if (edgeEffect2 != null && EdgeEffectCompat.getDistance(edgeEffect2) != BitmapDescriptorFactory.HUE_RED) {
                if (canScrollVertically(1)) {
                    ...
                    if (EdgeEffectCompat.getDistance(this.mBottomGlow) == BitmapDescriptorFactory.HUE_RED) {
                        this.mBottomGlow.onRelease();
                    }
                    f2 = fOnPullDistance;
                }
    ...
    public boolean fling(int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            if (edgeEffect3 != null && EdgeEffectCompat.getDistance(edgeEffect3) != BitmapDescriptorFactory.HUE_RED) {
                int i5 = -i2;
                ...
                if (edgeEffect4 != null && EdgeEffectCompat.getDistance(edgeEffect4) != BitmapDescriptorFactory.HUE_RED) {
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != BitmapDescriptorFactory.HUE_RED) {
        ...
        if (i >= 0 || edgeEffect2 == null || EdgeEffectCompat.getDistance(edgeEffect2) == BitmapDescriptorFactory.HUE_RED) {
            return i;
        }
        float f = i2;
    ...
    */
    ...
    private boolean stopGlowAnimations(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.mLeftGlow;
        if (edgeEffect == null || EdgeEffectCompat.getDistance(edgeEffect) == BitmapDescriptorFactory.HUE_RED || canScrollHorizontally(-1)) {
            z = false;
        } else {
            EdgeEffectCompat.onPullDistance(this.mLeftGlow, BitmapDescriptorFactory.HUE_RED, 1.0f - (motionEvent.getY() / getHeight()));
            z = true;
        }
        EdgeEffect edgeEffect2 = this.mRightGlow;
        if (edgeEffect2 != null && EdgeEffectCompat.getDistance(edgeEffect2) != BitmapDescriptorFactory.HUE_RED && !canScrollHorizontally(1)) {
            EdgeEffectCompat.onPullDistance(this.mRightGlow, BitmapDescriptorFactory.HUE_RED, motionEvent.getY() / getHeight());
            z = true;
        }
        EdgeEffect edgeEffect3 = this.mTopGlow;
        if (edgeEffect3 != null && EdgeEffectCompat.getDistance(edgeEffect3) != BitmapDescriptorFactory.HUE_RED && !canScrollVertically(-1)) {
            EdgeEffectCompat.onPullDistance(this.mTopGlow, BitmapDescriptorFactory.HUE_RED, motionEvent.getX() / getWidth());
            z = true;
        }
        EdgeEffect edgeEffect4 = this.mBottomGlow;
        if (edgeEffect4 == null || EdgeEffectCompat.getDistance(edgeEffect4) == BitmapDescriptorFactory.HUE_RED || canScrollVertically(1)) {
            return z;
        }
        EdgeEffectCompat.onPullDistance(this.mBottomGlow, BitmapDescriptorFactory.HUE_RED, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    void offsetPositionRecordsForMove(int i, int i2) {
        ...
        for (int i7 = 0; i7 < unfilteredChildCount; i7++) {
            ...
            if (childViewHolderInt != null && (i6 = childViewHolderInt.mPosition) >= i4 && i6 <= i3) {
                if (sVerboseLoggingEnabled) {
                    Log.d("RecyclerView", "offsetPositionRecordsForMove attached child " + i7 + " holder " + childViewHolderInt);
                }
        ...
        void offsetPositionRecordsForInsert(int i, int i2) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (viewHolder != null && viewHolder.mPosition >= i) {
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d("RecyclerView", "offsetPositionRecordsForInsert cached " + i3 + " holder " + viewHolder + " now at position " + (viewHolder.mPosition + i2));
                    }
  ...
  0x000c: PHI (r3v5 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x0010, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(Currencies.NPR) || !viewHolder.isBound()) {
            return -1;
        }
