...
public class LinearSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i, int i2) {
        ...
        if (layoutManager.canScrollHorizontally()) {
            ...
            if (pointFComputeScrollVectorForPosition.x < BitmapDescriptorFactory.HUE_RED) {
        ...
        if (layoutManager.canScrollVertically()) {
            ...
            if (pointFComputeScrollVectorForPosition.y < BitmapDescriptorFactory.HUE_RED) {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i, int i2) {
        ...
        if (fComputeDistancePerChild <= BitmapDescriptorFactory.HUE_RED) {
            return 0;
        }
