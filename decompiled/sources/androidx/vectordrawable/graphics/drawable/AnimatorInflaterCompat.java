...
public class AnimatorInflaterCompat {
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        if (z3) {
            if (z) {
                if (i4 == 5) {
                    dimension2 = typedArray.getDimension(i2, BitmapDescriptorFactory.HUE_RED);
                } else {
                    dimension2 = typedArray.getFloat(i2, BitmapDescriptorFactory.HUE_RED);
                }
                if (z2) {
                    if (i5 == 5) {
                        dimension3 = typedArray.getDimension(i3, BitmapDescriptorFactory.HUE_RED);
                    } else {
                        dimension3 = typedArray.getFloat(i3, BitmapDescriptorFactory.HUE_RED);
                    }
                ...
                if (i5 == 5) {
                    dimension = typedArray.getDimension(i3, BitmapDescriptorFactory.HUE_RED);
                } else {
                    dimension = typedArray.getFloat(i3, BitmapDescriptorFactory.HUE_RED);
                }
            ...
            if (i4 == 5) {
                color2 = (int) typedArray.getDimension(i2, BitmapDescriptorFactory.HUE_RED);
            ...
            if (z2) {
                if (i5 == 5) {
                    color3 = (int) typedArray.getDimension(i3, BitmapDescriptorFactory.HUE_RED);
            ...
            if (i5 == 5) {
                color = (int) typedArray.getDimension(i3, BitmapDescriptorFactory.HUE_RED);
            } else if (isColorType(i5)) {
    ...
    */
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        ...
        if (z) {
            if (i == 0) {
                keyframeOfInt = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, "value", 0, BitmapDescriptorFactory.HUE_RED));
            } else {
