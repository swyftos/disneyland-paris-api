...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C05831(null), 3, null);
    }

    /* renamed from: androidx.lifecycle.BlockRunner$maybeRun$1, reason: invalid class name and case insensitive filesystem */
    static final class C05831 extends SuspendLambda implements Function2 {
        private /* synthetic */ Object L$0;
        int label;

        C05831(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C05831 c05831 = new C05831(continuation);
            c05831.L$0 = obj;
            return c05831;
        }
