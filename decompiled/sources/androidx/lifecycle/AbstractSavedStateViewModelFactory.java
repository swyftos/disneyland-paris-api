...
public abstract class AbstractSavedStateViewModelFactory extends ViewModelProvider.OnRequeryFactory implements ViewModelProvider.Factory {
    ...
    private final ViewModel create(String key, Class modelClass) {
        ...
        ViewModel viewModelCreate = create(key, modelClass, savedStateHandleControllerCreate.getHandle());
        viewModelCreate.addCloseable(LegacySavedStateHandleController.TAG_SAVED_STATE_HANDLE_CONTROLLER, savedStateHandleControllerCreate);
