...
public class FlexBuffersBuilder {
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.finished = false;
        this.keyComparator = new Comparator() { // from class: androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.1
    ...
    public ByteBuffer finish() {
        int iAlign = align(((Value) this.stack.get(0)).elemWidth(this.bb.writePosition(), 0));
        writeAny((Value) this.stack.get(0), iAlign);
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        for (int i7 = i2; i7 < this.stack.size(); i7++) {
            iMax2 = Math.max(iMax2, ((Value) this.stack.get(i7)).elemWidth(this.bb.writePosition(), i7 + i4));
            if (z && i7 == i2) {
                i6 = ((Value) this.stack.get(i7)).type;
        ...
        for (int i9 = i8; i9 < this.stack.size(); i9++) {
            writeAny((Value) this.stack.get(i9), iAlign);
        }
        if (!z) {
            while (i8 < this.stack.size()) {
                this.bb.put(((Value) this.stack.get(i8)).storedPackedType(iMax2));
                i8++;
            }
        }
        if (value != null) {
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            iMax = Math.max(iMax, Value.elemWidth(4, 0, ((Value) this.stack.get(i3)).key, this.bb.writePosition(), i3));
        }
        int iAlign = align(iMax);
        writeInt(j, iAlign);
        int iWritePosition = this.bb.writePosition();
        while (i < this.stack.size()) {
            int i4 = ((Value) this.stack.get(i)).key;
            writeOffset(((Value) this.stack.get(i)).key, iAlign);
            i++;
        }
