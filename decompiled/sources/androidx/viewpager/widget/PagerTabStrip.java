...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.mPrevText, new View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.1
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.mNextText, new View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
