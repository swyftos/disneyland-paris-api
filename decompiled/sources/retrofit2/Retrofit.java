...
public final class Retrofit {
    ...
    ServiceMethod loadServiceMethod(Method method) {
        ...
        synchronized (this.serviceMethodCache) {
            try {
                annotations = (ServiceMethod) this.serviceMethodCache.get(method);
                if (annotations == null) {
    ...
    public <T> Converter<T, RequestBody> nextRequestBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i = iIndexOf; i < size; i++) {
            Converter<T, RequestBody> converter = (Converter<T, RequestBody>) ((Converter.Factory) this.converterFactories.get(i)).requestBodyConverter(type, annotationArr, annotationArr2, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<ResponseBody, T> nextResponseBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr) {
        ...
        int size = this.converterFactories.size();
        for (int i = iIndexOf; i < size; i++) {
            Converter<ResponseBody, T> converter = (Converter<ResponseBody, T>) ((Converter.Factory) this.converterFactories.get(i)).responseBodyConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<T, String> stringConverter(Type type, Annotation[] annotationArr) {
        ...
        for (int i = 0; i < size; i++) {
            Converter<T, String> converter = (Converter<T, String>) ((Converter.Factory) this.converterFactories.get(i)).stringConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public static final class Builder {
        ...
        Builder(Retrofit retrofit) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                this.callAdapterFactories.add((CallAdapter.Factory) retrofit.callAdapterFactories.get(i2));
            }
