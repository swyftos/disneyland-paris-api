...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    private static final Comparator NATURAL_ORDER = new Comparator() { // from class: gherkin.deps.com.google.gson.internal.LinkedTreeMap.1
    ...
    class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return new LinkedTreeMapIterator() { // from class: gherkin.deps.com.google.gson.internal.LinkedTreeMap.EntrySet.1
                {
                    LinkedTreeMap linkedTreeMap = LinkedTreeMap.this;
                }
    ...
    final class KeySet extends AbstractSet {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator iterator() {
            return new LinkedTreeMapIterator() { // from class: gherkin.deps.com.google.gson.internal.LinkedTreeMap.KeySet.1
                {
                    LinkedTreeMap linkedTreeMap = LinkedTreeMap.this;
                }
