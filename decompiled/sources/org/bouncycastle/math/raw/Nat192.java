...
public abstract class Nat192 {
    ...
    public static int addTo(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        iArr2[i2 + 4] = (int) j5;
        long j6 = (j5 >>> 32) + (iArr[i + 5] & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & iArr2[r12]);
        iArr2[i2 + 5] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        long j5 = (j4 >>> 32) + (iArr[4] & BodyPartID.bodyIdMax) + (iArr2[4] & BodyPartID.bodyIdMax);
        iArr2[4] = (int) j5;
        long j6 = (j5 >>> 32) + (iArr[5] & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & iArr2[5]);
        iArr2[5] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        iArr[i + 4] = i7;
        iArr2[i2 + 4] = i7;
        long j6 = (j5 >>> 32) + (iArr[r12] & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & iArr2[r14]);
        int i8 = (int) j6;
        iArr[i + 5] = i8;
        iArr2[i2 + 5] = i8;
        return (int) (j6 >>> 32);
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        long j7 = iArr[i] & BodyPartID.bodyIdMax;
        long j8 = j7 * j;
        iArr3[i3] = (int) j8;
        long j9 = (j8 >>> 32) + (j7 * j2);
        iArr3[i3 + 1] = (int) j9;
        ...
        while (i4 < 6) {
            int i6 = i5 + 1;
            long j14 = iArr[i + i4] & BodyPartID.bodyIdMax;
            long j15 = j6;
            long j16 = (j14 * j) + (iArr3[i6] & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j16;
            int i7 = i4;
            long j17 = (j16 >>> 32) + (j14 * j2) + (iArr3[r24] & BodyPartID.bodyIdMax);
            iArr3[i5 + 2] = (int) j17;
            long j18 = (j17 >>> 32) + (j14 * j3) + (iArr3[r16] & BodyPartID.bodyIdMax);
            iArr3[i5 + 3] = (int) j18;
            int i8 = i5;
            long j19 = (j18 >>> 32) + (j14 * j4) + (iArr3[r12] & BodyPartID.bodyIdMax);
            iArr3[i5 + 4] = (int) j19;
            long j20 = (j19 >>> 32) + (j14 * j5) + (iArr3[r3] & BodyPartID.bodyIdMax);
            iArr3[i8 + 5] = (int) j20;
            long j21 = (j20 >>> 32) + (j14 * j15) + (iArr3[r3] & BodyPartID.bodyIdMax);
            iArr3[i8 + 6] = (int) j21;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        long j7 = iArr[0] & BodyPartID.bodyIdMax;
        long j8 = j7 * j;
        iArr3[0] = (int) j8;
        long j9 = (j8 >>> 32) + (j7 * j2);
        iArr3[1] = (int) j9;
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            long j14 = iArr[i] & BodyPartID.bodyIdMax;
            long j15 = (j14 * j) + (iArr3[i] & BodyPartID.bodyIdMax);
            iArr3[i] = (int) j15;
            int i3 = i + 1;
            long j16 = (j15 >>> 32) + (j14 * j2) + (iArr3[i3] & BodyPartID.bodyIdMax);
            iArr3[i3] = (int) j16;
            long j17 = j2;
            long j18 = (j16 >>> 32) + (j14 * j3) + (iArr3[r18] & BodyPartID.bodyIdMax);
            iArr3[i + 2] = (int) j18;
            long j19 = (j18 >>> 32) + (j14 * j4) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 3] = (int) j19;
            long j20 = (j19 >>> 32) + (j14 * j5) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 4] = (int) j20;
            long j21 = (j20 >>> 32) + (j14 * j6) + (iArr3[r3] & BodyPartID.bodyIdMax);
            iArr3[i + 5] = (int) j21;
    ...
    public static long mul33Add(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j14 = (j12 >>> 32) + (j * j13) + j11 + (BodyPartID.bodyIdMax & iArr2[i3 + 5]);
        iArr3[i4 + 5] = (int) j14;
        return (j14 >>> 32) + j13;
    }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        int i5 = i3;
        while (i4 < 6) {
            long j8 = iArr[i + i4] & BodyPartID.bodyIdMax;
            long j9 = j;
            long j10 = (j8 * j) + (iArr3[i5] & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j10;
            int i6 = i5 + 1;
            long j11 = (j10 >>> 32) + (j8 * j2) + (iArr3[i6] & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j11;
            long j12 = (j11 >>> 32) + (j8 * j3) + (iArr3[r5] & BodyPartID.bodyIdMax);
            iArr3[i5 + 2] = (int) j12;
            long j13 = (j12 >>> 32) + (j8 * j4) + (iArr3[r5] & BodyPartID.bodyIdMax);
            iArr3[i5 + 3] = (int) j13;
            long j14 = (j13 >>> 32) + (j8 * j5) + (iArr3[r5] & BodyPartID.bodyIdMax);
            iArr3[i5 + 4] = (int) j14;
            long j15 = (j14 >>> 32) + (j8 * j6) + (iArr3[r5] & BodyPartID.bodyIdMax);
            iArr3[i5 + 5] = (int) j15;
            long j16 = (j15 >>> 32) + (iArr3[r14] & BodyPartID.bodyIdMax) + j7;
            iArr3[i5 + 6] = (int) j16;
            j7 = j16 >>> 32;
            i4++;
            j = j9;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 6) {
            ...
            long j10 = j;
            long j11 = (iArr3[i] & BodyPartID.bodyIdMax) + (j9 * j);
            iArr3[i] = (int) j11;
            int i2 = i + 1;
            long j12 = (j11 >>> 32) + (j9 * j2) + (iArr3[i2] & BodyPartID.bodyIdMax);
            iArr3[i2] = (int) j12;
            long j13 = (j12 >>> 32) + (j9 * j3) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 2] = (int) j13;
            long j14 = (j13 >>> 32) + (j9 * j4) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 3] = (int) j14;
            long j15 = (j14 >>> 32) + (j9 * j5) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 4] = (int) j15;
            long j16 = (j15 >>> 32) + (j9 * j8) + (iArr3[r6] & BodyPartID.bodyIdMax);
            iArr3[i + 5] = (int) j16;
            long j17 = (j16 >>> 32) + (iArr3[r0] & BodyPartID.bodyIdMax) + j7;
            iArr3[i + 6] = (int) j17;
            j7 = j17 >>> 32;
            i = i2;
            j6 = j8;
    ...
    public static int mulWordAddExt(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        iArr2[i3 + 4] = (int) j6;
        long j7 = (j6 >>> 32) + (j * (iArr[i2 + 5] & BodyPartID.bodyIdMax)) + (iArr2[r15] & BodyPartID.bodyIdMax);
        iArr2[i3 + 5] = (int) j7;
        return (int) (j7 >>> 32);
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j45 = BodyPartID.bodyIdMax & j42;
                long j46 = j36 + (j * j41);
                int i11 = (int) j46;
    ...
    public static int subFrom(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        iArr2[i2 + 4] = (int) j5;
        long j6 = (j5 >> 32) + ((iArr2[r13] & BodyPartID.bodyIdMax) - (iArr[i + 5] & BodyPartID.bodyIdMax));
        iArr2[i2 + 5] = (int) j6;
        return (int) (j6 >> 32);
    }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[4] = (int) j5;
        long j6 = (j5 >> 32) + ((iArr2[5] & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & iArr[5]));
        iArr2[5] = (int) j6;
        return (int) (j6 >> 32);
    }
