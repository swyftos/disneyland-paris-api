...
public class Interleave {
    ...
    public static long expand32to64(int i) {
        return (((r6 >>> 1) & 1431655765) << 32) | (1431655765 & Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i, MotionEventCompat.ACTION_POINTER_INDEX_MASK, 8), 15728880, 4), 202116108, 2), 572662306, 1));
    }
    ...
    public static void expand64To128(long j, long[] jArr, int i) {
        ...
        jArr[i] = jBitPermuteStep & 6148914691236517205L;
        jArr[i + 1] = (jBitPermuteStep >>> 1) & 6148914691236517205L;
    }
    ...
    public static void expand64To128Rev(long j, long[] jArr, int i) {
        long jBitPermuteStep = Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(j, 4294901760L, 16), 280375465148160L, 8), 67555025218437360L, 4), 868082074056920076L, 2), 2459565876494606882L, 1);
        jArr[i] = jBitPermuteStep & (-6148914691236517206L);
        jArr[i + 1] = (jBitPermuteStep << 1) & (-6148914691236517206L);
    }
