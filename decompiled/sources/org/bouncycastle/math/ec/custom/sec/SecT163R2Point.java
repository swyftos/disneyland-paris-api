    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT163R2Point(curve, eCFieldElementMultiply8, curve.getB().sqrt());
            }
        ...
        return new SecT163R2Point(curve, eCFieldElementAddOne, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
