...
public class SecP192R1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j4 = j2 + (BodyPartID.bodyIdMax & iArr[2]) + 1;
        iArr[2] = (int) j4;
        if ((j4 >> 32) != 0) {
            Nat.incAt(6, iArr, 3);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        long j = iArr[6] & BodyPartID.bodyIdMax;
        long j2 = iArr[7] & BodyPartID.bodyIdMax;
        long j3 = iArr[8] & BodyPartID.bodyIdMax;
        long j4 = iArr[9] & BodyPartID.bodyIdMax;
        long j5 = (iArr[10] & BodyPartID.bodyIdMax) + j;
        long j6 = (iArr[11] & BodyPartID.bodyIdMax) + j2;
        long j7 = (iArr[0] & BodyPartID.bodyIdMax) + j5;
        int i = (int) j7;
        long j8 = (j7 >> 32) + (iArr[1] & BodyPartID.bodyIdMax) + j6;
        int i2 = (int) j8;
        iArr2[1] = i2;
        long j9 = j5 + j3;
        long j10 = j6 + j4;
        long j11 = (j8 >> 32) + (iArr[2] & BodyPartID.bodyIdMax) + j9;
        long j12 = j11 & BodyPartID.bodyIdMax;
        long j13 = (j11 >> 32) + (iArr[3] & BodyPartID.bodyIdMax) + j10;
        iArr2[3] = (int) j13;
        long j14 = (j13 >> 32) + (iArr[4] & BodyPartID.bodyIdMax) + (j9 - j);
        iArr2[4] = (int) j14;
        long j15 = (j14 >> 32) + (iArr[5] & BodyPartID.bodyIdMax) + (j10 - j2);
        iArr2[5] = (int) j15;
        long j16 = j15 >> 32;
        long j17 = j12 + j16;
        long j18 = j16 + (i & BodyPartID.bodyIdMax);
        iArr2[0] = (int) j18;
        long j19 = j18 >> 32;
        if (j19 != 0) {
            long j20 = j19 + (BodyPartID.bodyIdMax & i2);
            iArr2[1] = (int) j20;
            j17 += j20 >> 32;
        }
        iArr2[2] = (int) j17;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j6 = j4 + (BodyPartID.bodyIdMax & iArr[2]) + j2;
            iArr[2] = (int) j6;
            j = j6 >> 32;
        } else {
            j = 0;
