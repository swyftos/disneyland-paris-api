    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT163K1Point(curve, eCFieldElementMultiply8, curve.getB());
            }
        ...
        return new SecT163K1Point(curve, eCFieldElementAddOne, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
