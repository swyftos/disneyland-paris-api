    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT233R1Point(curve, eCFieldElementMultiply8, curve.getB().sqrt());
            }
        ...
        return new SecT233R1Point(curve, eCFieldElementAddOne, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
