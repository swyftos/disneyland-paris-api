...
class DefaultESTHttpClientProvider implements ESTClientProvider {
    ...
    public DefaultESTHttpClientProvider(JsseHostnameAuthorizer jsseHostnameAuthorizer, SSLSocketFactoryCreator sSLSocketFactoryCreator, int i, ChannelBindingProvider channelBindingProvider, Set set, Long l, boolean z) {
