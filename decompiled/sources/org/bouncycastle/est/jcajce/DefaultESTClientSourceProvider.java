...
class DefaultESTClientSourceProvider implements ESTClientSourceProvider {
    ...
    public DefaultESTClientSourceProvider(SSLSocketFactory sSLSocketFactory, JsseHostnameAuthorizer jsseHostnameAuthorizer, int i, ChannelBindingProvider channelBindingProvider, Set set, Long l, boolean z) {
    ...
    public Source makeSource(String str, int i) throws IOException {
        ...
        if (Strings.toLowerCase(sSLSocket.getSession().getCipherSuite()).contains(OneIDTrackerEvent.EVENT_PARAM_ANON)) {
