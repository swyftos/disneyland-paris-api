    ...
    */
    public byte[] getEncoded() {
        /*
            ...
            org.bouncycastle.asn1.ASN1Encodable r9 = r9.gostParams     // Catch: java.io.IOException -> L2b
            r4.<init>(r5, r9)     // Catch: java.io.IOException -> L2b
            org.bouncycastle.asn1.DEROctetString r9 = new org.bouncycastle.asn1.DEROctetString     // Catch: java.io.IOException -> L2b
            r9.<init>(r0)     // Catch: java.io.IOException -> L2b
            r3.<init>(r4, r9)     // Catch: java.io.IOException -> L2b
            byte[] r9 = r3.getEncoded(r1)     // Catch: java.io.IOException -> L2b
            return r9
        L2b:
            return r2
        L2c:
        ...
        Lb5:
            ...
            java.math.BigInteger r5 = r9.getS()
            org.bouncycastle.asn1.DERBitString r9 = r9.publicKey
            r4.<init>(r0, r5, r9, r3)
            goto Lce
        Lc5:
            org.bouncycastle.asn1.sec.ECPrivateKey r4 = new org.bouncycastle.asn1.sec.ECPrivateKey
            java.math.BigInteger r9 = r9.getS()
            r4.<init>(r0, r9, r3)
        Lce:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r9 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers.gostR3410_2001     // Catch: java.io.IOException -> Le7
            ...
            r9.<init>(r0, r3)     // Catch: java.io.IOException -> Le7
            byte[] r9 = r9.getEncoded(r1)     // Catch: java.io.IOException -> Le7
            return r9
        Le7:
            return r2
        */
