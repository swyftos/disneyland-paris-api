    ...
    */
    public byte[] getEncoded() {
        ...
        L9a:
            ...
            r3.<init>(r0, r4, r1)
        La3:
            java.lang.String r9 = r9.algorithm     // Catch: java.io.IOException -> Ldd
            java.lang.String r0 = "DSTU4145"
            boolean r9 = r9.equals(r0)     // Catch: java.io.IOException -> Ldd
            if (r9 == 0) goto Lc2
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r9 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1ObjectIdentifier r4 = org.bouncycastle.asn1.ua.UAObjectIdentifiers.dstu4145be     // Catch: java.io.IOException -> Ldd
            ...
            r9.<init>(r0, r1)     // Catch: java.io.IOException -> Ldd
            goto Ld6
        Lc2:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r9 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r0 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1ObjectIdentifier r4 = org.bouncycastle.asn1.x9.X9ObjectIdentifiers.id_ecPublicKey     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r1.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r0.<init>(r4, r1)     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r3.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r9.<init>(r0, r1)     // Catch: java.io.IOException -> Ldd
        Ld6:
            ...
            byte[] r9 = r9.getEncoded(r0)     // Catch: java.io.IOException -> Ldd
            return r9
        Ldd:
            return r2
        */
