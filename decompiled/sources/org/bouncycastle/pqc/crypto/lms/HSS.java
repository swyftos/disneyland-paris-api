    ...
    public static HSSSignature generateSignature(HSSPrivateKeyParameters hSSPrivateKeyParameters, byte[] bArr) {
        ...
        synchronized (hSSPrivateKeyParameters) {
            try {
                ...
                List keys = hSSPrivateKeyParameters.getKeys();
                List sig = hSSPrivateKeyParameters.getSig();
                int i = l - 1;
                lMSPrivateKeyParameters = (LMSPrivateKeyParameters) hSSPrivateKeyParameters.getKeys().get(i);
    ...
    static void rangeTestKeys(HSSPrivateKeyParameters hSSPrivateKeyParameters) {
        synchronized (hSSPrivateKeyParameters) {
            try {
                ...
                while (true) {
                    int i2 = i - 1;
                    if (((LMSPrivateKeyParameters) keys.get(i2)).getIndex() != (1 << ((LMSPrivateKeyParameters) keys.get(i2)).getSigParameters().getH())) {
                        while (i < l) {
