...
class BDSTreeHash implements Serializable, Cloneable {
    ...
    void update(Stack stack, WOTSPlus wOTSPlus, byte[] bArr, byte[] bArr2, OTSHashAddress oTSHashAddress) {
        ...
        while (!stack.isEmpty() && ((XMSSNode) stack.peek()).getHeight() == xMSSNodeLTree.getHeight() && ((XMSSNode) stack.peek()).getHeight() != this.initialHeight) {
            ...
            XMSSNode xMSSNodeRandomizeHash = XMSSNodeUtil.randomizeHash(wOTSPlus, (XMSSNode) stack.pop(), xMSSNodeLTree, hashTreeAddress2);
