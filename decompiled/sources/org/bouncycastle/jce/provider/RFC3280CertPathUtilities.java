...
abstract class RFC3280CertPathUtilities {
 ...
 binds: [B:38:0x00bb, B:44:0x00fe, B:40:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    protected static void prepareNextCertG(CertPath certPath, int i, PKIXNameConstraintValidator pKIXNameConstraintValidator) throws ExtCertPathValidatorException {
        try {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected static int prepareNextCertI1(java.security.cert.CertPath r3, int r4, int r5) throws org.bouncycastle.jce.exception.ExtCertPathValidatorException {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected static int prepareNextCertI2(java.security.cert.CertPath r4, int r5, int r6) throws org.bouncycastle.jce.exception.ExtCertPathValidatorException {
        /*
    ...
    protected static int prepareNextCertJ(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
        int iIntValueExact;
        try {
    ...
    protected static int prepareNextCertL(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
    ...
    protected static int prepareNextCertM(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
    ...
    protected static void prepareNextCertN(CertPath certPath, int i) throws ExtCertPathValidatorException {
    ...
    protected static PKIXPolicyNode processCertD(CertPath certPath, int i, Set set, PKIXPolicyNode pKIXPolicyNode, List[] listArr, int i2, boolean z) throws ExtCertPathValidatorException {
        String id;
        int i3;
        List<? extends Certificate> certificates = certPath.getCertificates();
        X509Certificate x509Certificate = (X509Certificate) certificates.get(i);
    ...
    protected static PKIXPolicyNode processCertE(CertPath certPath, int i, PKIXPolicyNode pKIXPolicyNode) throws ExtCertPathValidatorException {
        try {
    ...
    protected static void processCertF(CertPath certPath, int i, PKIXPolicyNode pKIXPolicyNode, int i2) throws ExtCertPathValidatorException {
    ...
    protected static int wrapupCertB(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
        try {
    ...
    protected static PKIXPolicyNode wrapupCertG(CertPath certPath, PKIXExtendedParameters pKIXExtendedParameters, Set set, int i, List[] listArr, PKIXPolicyNode pKIXPolicyNode, Set set2) throws ExtCertPathValidatorException {
