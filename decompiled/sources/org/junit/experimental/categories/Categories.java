...
public class Categories extends Suite {
    ...
    public static class CategoryFilter extends Filter {
        ...
        public static CategoryFilter include(boolean z, Class<?>... clsArr) {
            return new CategoryFilter(z, (Class[]) clsArr, true, (Class[]) null);
        }
        ...
        public static CategoryFilter exclude(boolean z, Class<?>... clsArr) {
            return new CategoryFilter(true, (Class[]) null, z, (Class[]) clsArr);
        }
        ...
        private boolean hasCorrectCategoryAnnotation(Description description) {
            Set setCategories = categories(description);
        ...
        private boolean matchesAnyParentCategories(Set set, Set set2) {
            Iterator it = set2.iterator();
            while (it.hasNext()) {
                if (Categories.hasAssignableTo(set, (Class) it.next())) {
                    return true;
                }
            }
            return false;
        ...
        private boolean matchesAllParentCategories(Set set, Set set2) {
            Iterator it = set2.iterator();
            while (it.hasNext()) {
                if (!Categories.hasAssignableTo(set, (Class) it.next())) {
                    return false;
        ...
        private static Set copyAndRefine(Set set) {
    ...
    private static Set getIncludedCategory(Class cls) {
    ...
    private static Set getExcludedCategory(Class cls) {
    ...
    public static boolean hasAssignableTo(Set set, Class cls) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Set createSet(Class[] clsArr) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Set nullableClassToSet(Class cls) {
