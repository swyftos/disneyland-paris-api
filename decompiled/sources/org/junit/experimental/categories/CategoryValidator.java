...
public final class CategoryValidator extends AnnotationValidator {
    private static final Set INCOMPATIBLE_ANNOTATIONS = Collections.unmodifiableSet(new HashSet(Arrays.asList(BeforeClass.class, AfterClass.class, Before.class, After.class)));
    ...
    private void addErrorMessage(List list, Class cls) {
