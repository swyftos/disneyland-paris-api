...
public class Theories extends BlockJUnit4ClassRunner {
    ...
    private void validateDataPointFields(List list) {
    ...
    private void validateDataPointMethods(List list) throws SecurityException {
    ...
    private void validateParameterSupplier(Class cls, List list) throws SecurityException {
    ...
    public static class TheoryAnchor extends Statement {
        ...
        protected void runWithCompleteAssignment(final Assignments assignments) throws Throwable {
            new BlockJUnit4ClassRunner(getTestClass()) { // from class: org.junit.experimental.theories.Theories.TheoryAnchor.1
                @Override // org.junit.runners.BlockJUnit4ClassRunner, org.junit.runners.ParentRunner
                protected void collectInitializationErrors(List list) {
                }
                ...
                @Override // org.junit.runners.BlockJUnit4ClassRunner
                public Object createTest() throws PotentialAssignment.CouldNotGenerateValueException {
