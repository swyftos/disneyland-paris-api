...
public class FailOnTimeout extends Statement {
    ...
    private Throwable getResult(FutureTask futureTask, Thread thread) {
        try {
            long j = this.timeout;
            if (j > 0) {
                return (Throwable) futureTask.get(j, this.timeUnit);
            }
    ...
    private List getThreadsInGroup(ThreadGroup threadGroup) {
