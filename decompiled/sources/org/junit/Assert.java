...
public class Assert {
    ...
    public static <T extends Throwable> T assertThrows(String str, Class<T> cls, ThrowingRunnable throwingRunnable) {
        try {
            ...
            if (str2.equals(str3)) {
                String str4 = str2 + GherkinLanguageConstants.TAG_PREFIX + Integer.toHexString(System.identityHashCode(cls));
                str3 = str3 + GherkinLanguageConstants.TAG_PREFIX + Integer.toHexString(System.identityHashCode(cls2));
                str2 = str4;
            }
