...
class NoGenericTypeParametersValidator {
    ...
    private void validateNoTypeParameterOnType(Type type, List list) {
    ...
    private void validateNoTypeParameterOnParameterizedType(ParameterizedType parameterizedType, List list) {
        for (Type type : parameterizedType.getActualTypeArguments()) {
            validateNoTypeParameterOnType(type, list);
        }
    }

    private void validateNoTypeParameterOnWildcardType(WildcardType wildcardType, List list) {
    ...
    private void validateNoTypeParameterOnGenericArrayType(GenericArrayType genericArrayType, List list) {
