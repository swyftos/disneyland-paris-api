...
public abstract class TestWatcher implements TestRule {
    ...
    public void succeededQuietly(Description description, List list) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void failedQuietly(Throwable th, Description description, List list) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void skippedQuietly(AssumptionViolatedException assumptionViolatedException, Description description, List list) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void startingQuietly(Description description, List list) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void finishedQuietly(Description description, List list) {
        try {
