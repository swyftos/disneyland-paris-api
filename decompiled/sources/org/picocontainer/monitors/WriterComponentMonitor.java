...
public class WriterComponentMonitor implements ComponentMonitor {
    ...
    public WriterComponentMonitor(Writer writer) {
        this(writer, new NullComponentMonitor());
    }

    public WriterComponentMonitor(Writer writer, ComponentMonitor componentMonitor) {
    ...
    public <T> void instantiationFailed(PicoContainer picoContainer, ComponentAdapter<T> componentAdapter, Constructor<T> constructor, Exception exc) {
        ...
        this.delegate.instantiationFailed(picoContainer, null, constructor, exc);
    }
