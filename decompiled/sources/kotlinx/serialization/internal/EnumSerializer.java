...
public final class EnumSerializer<T extends Enum<T>> implements KSerializer<T> {
    ...
    public EnumSerializer(@NotNull final String serialName, @NotNull T[] values) {
        ...
        this.values = values;
        this.descriptor = LazyKt.lazy(new Function0() { // from class: kotlinx.serialization.internal.EnumSerializer$descriptor$2
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        int iIndexOf = ArraysKt.indexOf((T[]) this.values, value);
        if (iIndexOf == -1) {
