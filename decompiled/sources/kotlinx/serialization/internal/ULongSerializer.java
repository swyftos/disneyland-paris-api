...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m3027boximpl(m3727deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m3728serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }
    ...
    public void m3728serialize2TYgG_w(@NotNull Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeLong(value);
    }

    /* renamed from: deserialize-I7RO_PI, reason: not valid java name */
    public long m3727deserializeI7RO_PI(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m3028constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
