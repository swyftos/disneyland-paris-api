...
public abstract class JsonReader {
    ...
    private final void writeRange(int fromIndex, int toIndex, boolean currentChunkHasEscape, Function1 consumeChunk) {
    ...
    public final void failOnUnknownKey(@NotNull String key) {
        ...
        fail("Encountered an unknown key '" + key + CoreConstants.SINGLE_QUOTE_CHAR, StringsKt.lastIndexOf$default((CharSequence) substring(0, this.currentPosition), key, 0, false, 6, (Object) null), AbstractJsonLexerKt.ignoreUnknownKeysHint);
        throw new KotlinNothingValueException();
    }
