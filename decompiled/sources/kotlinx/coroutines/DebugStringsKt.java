...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(@NotNull Continuation<?> continuation) {
        ...
        try {
            ...
            objM2968constructorimpl = Result.m2968constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m2971exceptionOrNullimpl(objM2968constructorimpl) != null) {
            objM2968constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) objM2968constructorimpl;
    }
