...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        if (hostname != null && hostname.length() != 0 && !StringsKt.startsWith$default(hostname, InstructionFileId.DOT, false, 2, (Object) null) && !StringsKt.endsWith$default(hostname, CallerDataConverter.DEFAULT_RANGE_DELIMITER, false, 2, (Object) null) && pattern != null && pattern.length() != 0 && !StringsKt.startsWith$default(pattern, InstructionFileId.DOT, false, 2, (Object) null) && !StringsKt.endsWith$default(pattern, CallerDataConverter.DEFAULT_RANGE_DELIMITER, false, 2, (Object) null)) {
