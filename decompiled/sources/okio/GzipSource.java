...
public final class GzipSource implements Source {
    ...
    private final void consumeTrailer() throws IOException {
        checkEqual(Currencies.AlphabeticCode.CRC_STR, this.source.readIntLe(), (int) this.crc.getValue());
