...
public final class DeserializerCache implements Serializable {
    ...
    */
    private io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType modifyTypeByAnnotation(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationContext r5, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.Annotated r6, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r7) {
        /*
            r4 = this;
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.AnnotationIntrospector r0 = r5.getAnnotationIntrospector()
            if (r0 != 0) goto L7
            return r7
        L7:
            boolean r1 = r7.isMapLikeType()
            if (r1 == 0) goto L2e
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r1 = r7.getKeyType()
            if (r1 == 0) goto L2e
            java.lang.Object r1 = r1.getValueHandler()
            if (r1 != 0) goto L2e
            java.lang.Object r1 = r0.findKeyDeserializer(r6)
            if (r1 == 0) goto L2e
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.KeyDeserializer r1 = r5.keyDeserializerInstance(r6, r1)
            if (r1 == 0) goto L2e
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.type.MapLikeType r7 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.type.MapLikeType) r7
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.type.MapLikeType r7 = r7.withKeyValueHandler(r1)
            r7.getKeyType()
        L2e:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r1 = r7.getContentType()
            if (r1 == 0) goto L5d
            java.lang.Object r1 = r1.getValueHandler()
            if (r1 != 0) goto L5d
            java.lang.Object r1 = r0.findContentDeserializer(r6)
            if (r1 == 0) goto L5d
            boolean r2 = r1 instanceof io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer
            if (r2 == 0) goto L47
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer r1 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer) r1
            goto L56
        L47:
            java.lang.String r2 = "findContentDeserializer"
            java.lang.Class<io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer$None> r3 = io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer.None.class
            java.lang.Class r4 = r4._verifyAsClass(r1, r2, r3)
            if (r4 == 0) goto L56
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer r4 = r5.deserializerInstance(r6, r4)
            goto L57
        L56:
            r4 = 0
        L57:
            if (r4 == 0) goto L5d
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r7 = r7.withContentValueHandler(r4)
        L5d:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationConfig r4 = r5.getConfig()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r4 = r0.refineDeserializationType(r4, r6, r7)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.DeserializerCache.modifyTypeByAnnotation(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationContext, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.Annotated, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType):io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType");
    }
