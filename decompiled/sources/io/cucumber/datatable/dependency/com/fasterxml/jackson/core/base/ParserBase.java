...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.core.json.DupDetector;
...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    private void _parseSlowFloat(int i) throws JsonParseException {
        try {
            if (i == 16) {
    ...
    protected void _reportTooLongInt(int i, String str) throws IOException {
        _reportError("Numeric value (%s) out of range of %s", _longIntegerDesc(str), i == 2 ? LongTypedProperty.TYPE : "int");
    }
