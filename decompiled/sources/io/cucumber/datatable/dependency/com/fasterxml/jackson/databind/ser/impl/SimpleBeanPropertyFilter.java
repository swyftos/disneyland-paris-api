...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyFilter;
...
public class SimpleBeanPropertyFilter implements BeanPropertyFilter, PropertyFilter {
    ...
    public static PropertyFilter from(final BeanPropertyFilter beanPropertyFilter) {
        return new PropertyFilter() { // from class: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.impl.SimpleBeanPropertyFilter.1
            @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.PropertyFilter
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyFilter
    @Deprecated
    ...
    public static class FilterExceptFilter extends SimpleBeanPropertyFilter implements Serializable {
        ...
        @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.impl.SimpleBeanPropertyFilter
        protected boolean include(BeanPropertyWriter beanPropertyWriter) {
