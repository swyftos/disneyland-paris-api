...
public @interface JsonIgnoreProperties {
    ...
    public static class Value implements JacksonAnnotationValue<JsonIgnoreProperties>, Serializable {
        ...
        private static Set _asSet(String[] strArr) {
        ...
        private static Set _merge(Set set, Set set2) {
            if (set.isEmpty()) {
                return set2;
            }
            if (set2.isEmpty()) {
        ...
        private static boolean _empty(Set set, boolean z, boolean z2, boolean z3, boolean z4) {
            Value value = EMPTY;
