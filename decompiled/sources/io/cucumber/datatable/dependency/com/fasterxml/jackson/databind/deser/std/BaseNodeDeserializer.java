...
abstract class BaseNodeDeserializer extends StdDeserializer {
    ...
    */
    protected final io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode updateObject(io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonParser r11, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationContext r12, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ObjectNode r13) throws java.io.IOException {
        /*
            r10 = this;
            ...
            goto L1e
        Lb:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonToken r0 = io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonToken.FIELD_NAME
            boolean r0 = r11.hasToken(r0)
            if (r0 != 0) goto L1a
            java.lang.Object r10 = r10.deserialize(r11, r12)
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r10 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode) r10
            return r10
        L1a:
            java.lang.String r0 = r11.getCurrentName()
        L1e:
            if (r0 == 0) goto Lb0
            io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonToken r1 = r11.nextToken()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r7 = r13.get(r0)
            if (r7 == 0) goto L4e
            boolean r2 = r7 instanceof io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ObjectNode
            if (r2 == 0) goto L3c
            r1 = r7
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ObjectNode r1 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ObjectNode) r1
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r1 = r10.updateObject(r11, r12, r1)
            if (r1 == r7) goto Laa
            r13.set(r0, r1)
            goto Laa
        L3c:
            boolean r2 = r7 instanceof io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ArrayNode
            if (r2 == 0) goto L4e
            r1 = r7
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ArrayNode r1 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ArrayNode) r1
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r1 = r10.updateArray(r11, r12, r1)
            if (r1 == r7) goto Laa
            r13.set(r0, r1)
            goto Laa
        L4e:
            if (r1 != 0) goto L52
            io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonToken r1 = io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonToken.NOT_AVAILABLE
        L52:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.JsonNodeFactory r4 = r12.getNodeFactory()
            int r1 = r1.id()
            r2 = 1
            if (r1 == r2) goto L97
            r3 = 3
        ...
        L69:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r1 = r10.deserializeAny(r11, r12, r4)
        L6d:
            r9 = r1
            goto L9c
        L6f:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r1 = r10._fromEmbedded(r11, r12, r4)
            goto L6d
        L74:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.NullNode r1 = r4.nullNode()
            goto L6d
        L79:
            r1 = 0
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.BooleanNode r1 = r4.booleanNode(r1)
            goto L6d
        L7f:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.BooleanNode r1 = r4.booleanNode(r2)
            goto L6d
        L84:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonNode r1 = r10._fromInt(r11, r12, r4)
            goto L6d
        L89:
            java.lang.String r1 = r11.getText()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.TextNode r1 = r4.textNode(r1)
            goto L6d
        L92:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ArrayNode r1 = r10.deserializeArray(r11, r12, r4)
            goto L6d
        L97:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.ObjectNode r1 = r10.deserializeObject(r11, r12, r4)
            goto L6d
        L9c:
            if (r7 == 0) goto La7
            r1 = r10
