...
public abstract class AsArraySerializerBase<T> extends ContainerSerializer<T> implements ContextualSerializer {
    ...
    */
    public io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer<?> createContextual(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.SerializerProvider r6, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.BeanProperty r7) throws io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonMappingException {
        /*
            r5 = this;
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeSerializer r0 = r5._valueTypeSerializer
            if (r0 == 0) goto L8
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeSerializer r0 = r0.forProperty(r7)
        L8:
            r1 = 0
            if (r7 == 0) goto L20
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.AnnotationIntrospector r2 = r6.getAnnotationIntrospector()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedMember r3 = r7.getMember()
            if (r3 == 0) goto L20
            java.lang.Object r2 = r2.findContentSerializer(r3)
            if (r2 == 0) goto L20
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r2 = r6.serializerInstance(r3, r2)
            goto L21
        L20:
            r2 = r1
        L21:
            java.lang.Class r3 = r5.handledType()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.annotation.JsonFormat$Value r3 = r5.findFormatOverrides(r6, r7, r3)
            if (r3 == 0) goto L31
            io.cucumber.datatable.dependency.com.fasterxml.jackson.annotation.JsonFormat$Feature r1 = io.cucumber.datatable.dependency.com.fasterxml.jackson.annotation.JsonFormat.Feature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED
            java.lang.Boolean r1 = r3.getFeature(r1)
        L31:
            if (r2 != 0) goto L35
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer<java.lang.Object> r2 = r5._elementSerializer
        L35:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r2 = r5.findContextualConvertingSerializer(r6, r7, r2)
            if (r2 != 0) goto L4f
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r3 = r5._elementType
            if (r3 == 0) goto L4f
            boolean r4 = r5._staticTyping
            if (r4 == 0) goto L4f
            boolean r3 = r3.isJavaLangObject()
            if (r3 != 0) goto L4f
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r2 = r5._elementType
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r2 = r6.findValueSerializer(r2, r7)
        L4f:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer<java.lang.Object> r6 = r5._elementSerializer
            if (r2 != r6) goto L61
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.BeanProperty r6 = r5._property
            if (r7 != r6) goto L61
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeSerializer r6 = r5._valueTypeSerializer
            if (r6 != r0) goto L61
        ...
        L60:
            return r5
        L61:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.std.AsArraySerializerBase r5 = r5.withResolved(r7, r0, r2, r1)
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.std.AsArraySerializerBase.createContextual(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.SerializerProvider, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.BeanProperty):io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer");
    }
