...
final class AnnotatedCreatorCollector extends CollectorBase {
    ...
    */
    protected io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor constructNonDefaultConstructor(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.ClassUtil.Ctor r8, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.ClassUtil.Ctor r9) {
        /*
            r7 = this;
            int r0 = r8.getParamCount()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.AnnotationIntrospector r1 = r7._intr
            if (r1 != 0) goto L1c
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor r9 = new io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.TypeResolutionContext r7 = r7._typeContext
            java.lang.reflect.Constructor r8 = r8.getConstructor()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap r1 = io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.CollectorBase._emptyAnnotationMap()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap[] r0 = io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.CollectorBase._emptyAnnotationMaps(r0)
            r9.<init>(r7, r8, r1, r0)
            return r9
        L1c:
            if (r0 != 0) goto L30
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor r0 = new io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.TypeResolutionContext r1 = r7._typeContext
            java.lang.reflect.Constructor r2 = r8.getConstructor()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap r7 = r7.collectAnnotations(r8, r9)
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap[] r8 = io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.CollectorBase.NO_ANNOTATION_MAPS
            r0.<init>(r1, r2, r7, r8)
            return r0
        L30:
            ...
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap[] r3 = r7.collectAnnotations(r2, r3)
        L54:
            r1 = r2
            goto L72
        L56:
            ...
            java.lang.annotation.Annotation[] r1 = io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.CollectorBase.NO_ANNOTATIONS
            r2[r5] = r1
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap[] r3 = r7.collectAnnotations(r2, r3)
            goto L54
        L72:
        ...
        L9d:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationMap[] r3 = r7.collectAnnotations(r1, r3)
        La1:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor r0 = new io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.TypeResolutionContext r1 = r7._typeContext
            java.lang.reflect.Constructor r2 = r8.getConstructor()
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedCreatorCollector.constructNonDefaultConstructor(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.ClassUtil$Ctor, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.ClassUtil$Ctor):io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotatedConstructor");
    }
