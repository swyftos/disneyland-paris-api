...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.AnnotationCollector;
...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
    ...
    AnnotatedClass(JavaType javaType, Class cls, List list, Class cls2, Annotations annotations, TypeBindings typeBindings, AnnotationIntrospector annotationIntrospector, ClassIntrospector.MixInResolver mixInResolver, TypeFactory typeFactory) {
        this._type = javaType;
        this._class = cls;
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.TypeResolutionContext
    ...
    private final List _fields() {
        ...
        if (listCollectFields == null) {
            ...
            if (javaType == null) {
                ...
                listCollectFields = AnnotatedFieldCollector.collectFields(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, javaType);
            }
    ...
    private final AnnotatedMethodMap _methods() {
        ...
        if (annotatedMethodMapCollectMethods == null) {
            ...
            if (javaType == null) {
                ...
                annotatedMethodMapCollectMethods = AnnotatedMethodCollector.collectMethods(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, javaType, this._superTypes, this._primaryMixIn);
            }
    ...
    private final Creators _creators() {
        ...
        if (creatorsCollectCreators == null) {
            ...
            if (javaType == null) {
                ...
                creatorsCollectCreators = AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this, javaType, this._primaryMixIn);
            }
