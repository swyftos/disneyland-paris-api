...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.impl.CreatorCandidate;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.impl.CreatorCollector;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.impl.JavaUtilCollectionsDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.ArrayBlockingQueueDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.AtomicReferenceDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.CollectionDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.DateDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.EnumDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.EnumSetDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.JdkDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.JsonLocationInstantiator;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.JsonNodeDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.MapEntryDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.NumberDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.ObjectArrayDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.PrimitiveArrayDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StdKeyDeserializers;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StringArrayDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StringCollectionDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StringDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.TokenBufferDeserializer;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.UntypedObjectDeserializer;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.POJOPropertyBuilder;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.ConstantValueInstantiator;
...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    static {
        ...
        map.put(AbstractMap.class.getName(), LinkedHashMap.class);
        ...
        map2.put(AbstractList.class.getName(), ArrayList.class);
        map2.put(AbstractSet.class.getName(), HashSet.class);
    ...
    /* renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.BasicDeserializerFactory$1, reason: invalid class name */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v11, types: [io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.BeanPropertyDefinition] */
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int i, AnnotatedParameter annotatedParameter, JacksonInject.Value value) throws JsonMappingException {
        ...
        CreatorProperty creatorProperty = new CreatorProperty(propertyName, javaTypeResolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializerFindTypeDeserializer, beanDescription.getClassAnnotations(), annotatedParameter, i, value == null ? null : value.getId(), propertyMetadata);
    ...
    */
    public io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer<?> createMapDeserializer(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationContext r20, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.type.MapType r21, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.BeanDescription r22) throws io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonMappingException {
        /*
            Method dump skipped, instructions count: 301
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.BasicDeserializerFactory.createMapDeserializer(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.DeserializationContext, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.type.MapType, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.BeanDescription):io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonDeserializer");
    }
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.DeserializerFactory
    public JsonDeserializer<?> createEnumDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws JsonMappingException, SecurityException {
        DeserializationConfig config = deserializationContext.getConfig();
        Class<?> rawClass = javaType.getRawClass();
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.DeserializerFactory
    public KeyDeserializer createKeyDeserializer(DeserializationContext deserializationContext, JavaType javaType) throws JsonMappingException, SecurityException {
        DeserializationConfig config = deserializationContext.getConfig();
    ...
    private KeyDeserializer _createEnumKeyDeserializer(DeserializationContext deserializationContext, JavaType javaType) throws JsonMappingException, SecurityException {
        DeserializationConfig config = deserializationContext.getConfig();
        Class<?> rawClass = javaType.getRawClass();
