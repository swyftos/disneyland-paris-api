...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    public static StdKeyDeserializer forType(Class<?> cls) {
        ...
        if (cls == String.class || cls == Object.class || cls == CharSequence.class) {
            return StringKD.forType((Class) cls);
        }
        if (cls == UUID.class) {
            i = 12;
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.KeyDeserializer
    ...
    protected Object _parse(String str, DeserializationContext deserializationContext) throws Exception {
        switch (this._kind) {
            case 1:
                if (Characteristics.TRUE.equals(str)) {
                    return Boolean.TRUE;
                }
                if ("false".equals(str)) {
    ...
    static final class StringKD extends StdKeyDeserializer {
        ...
        @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.KeyDeserializer
    ...
    static final class EnumKD extends StdKeyDeserializer {
        ...
        @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer
        public Object _parse(String str, DeserializationContext deserializationContext) {
            ...
            if (this._enumDefaultValue == null || !deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE)) {
                return !deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL) ? deserializationContext.handleWeirdKey(this._keyClass, str, "not one of values excepted for Enum class: %s", enumResolver_getToStringResolver.getEnumIds()) : enumFindEnum;
            }
