...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.AnyGetterWriter;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyWriter;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanSerializerBuilder;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.PropertyWriter;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.impl.WritableObjectId;
...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    */
    public void resolve(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.SerializerProvider r8) throws io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonMappingException {
        /*
            r7 = this;
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyWriter[] r0 = r7._filteredProps
            r1 = 0
            if (r0 != 0) goto L7
            r0 = r1
            goto L8
        L7:
            int r0 = r0.length
        L8:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyWriter[] r2 = r7._props
            int r2 = r2.length
        Lb:
            if (r1 >= r2) goto L93
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyWriter[] r3 = r7._props
            r3 = r3[r1]
            boolean r4 = r3.willSuppressNulls()
            if (r4 != 0) goto L31
            boolean r4 = r3.hasNullSerializer()
            if (r4 != 0) goto L31
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r4 = r8.findNullValueSerializer(r3)
            if (r4 == 0) goto L31
            r3.assignNullSerializer(r4)
            if (r1 >= r0) goto L31
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanPropertyWriter[] r5 = r7._filteredProps
            r5 = r5[r1]
            if (r5 == 0) goto L31
        ...
        L31:
            ...
            goto L8f
        L38:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r4 = r7.findConvertingSerializer(r8, r3)
            if (r4 != 0) goto L80
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r4 = r3.getSerializationType()
            if (r4 != 0) goto L5e
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r4 = r3.getType()
        ...
        L5a:
            ...
            goto L8f
        L5e:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JsonSerializer r5 = r8.findValueSerializer(r4, r3)
            boolean r6 = r4.isContainerType()
            if (r6 == 0) goto L7f
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.JavaType r4 = r4.getContentType()
            java.lang.Object r4 = r4.getTypeHandler()
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeSerializer r4 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeSerializer) r4
            if (r4 == 0) goto L7f
            boolean r6 = r5 instanceof io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.ContainerSerializer
            if (r6 == 0) goto L7f
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.ContainerSerializer r5 = (io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.ContainerSerializer) r5
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.ContainerSerializer r4 = r5.withValueTypeSerializer(r4)
            goto L80
        L7f:
            r4 = r5
        L80:
        ...
        L8f:
            ...
            goto Lb
        L93:
            io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.AnyGetterWriter r7 = r7._anyGetterWriter
            if (r7 == 0) goto L9a
            r7.resolve(r8)
        L9a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.std.BeanSerializerBase.resolve(io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.SerializerProvider):void");
    }
    ...
    /* renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.std.BeanSerializerBase$1, reason: invalid class name */
