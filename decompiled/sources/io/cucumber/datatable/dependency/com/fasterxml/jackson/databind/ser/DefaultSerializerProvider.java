...
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.SerializerProvider
    ...
    private final void _serialize(JsonGenerator jsonGenerator, Object obj, JsonSerializer jsonSerializer, PropertyName propertyName) throws IOException {
        try {
            jsonGenerator.writeStartObject();
    ...
    private final void _serialize(JsonGenerator jsonGenerator, Object obj, JsonSerializer jsonSerializer) throws IOException {
        try {
            jsonSerializer.serialize(obj, jsonGenerator, this);
        } catch (Exception e) {
            throw _wrapAsIOE(jsonGenerator, e);
    ...
    public static final class Impl extends DefaultSerializerProvider {
        ...
        @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.DefaultSerializerProvider
        public DefaultSerializerProvider copy() {
