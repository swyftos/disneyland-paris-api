...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.annotation.PropertyAccessor;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.Module;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.cfg.BaseSettings;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.cfg.ConfigOverrides;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.BeanDeserializerFactory;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.BasicClassIntrospector;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.ClassIntrospector;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.introspect.JacksonAnnotationIntrospector;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.impl.StdSubtypeResolver;
...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanSerializerFactory;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.BeanSerializerModifier;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.DefaultSerializerProvider;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.FilterProvider;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ser.SerializerFactory;
...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder, io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder
    ...
    /* renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ObjectMapper$3, reason: invalid class name */
    ...
    public ObjectMapper registerModule(Module module) {
        ...
        module.setupModule(new Module.SetupContext() { // from class: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ObjectMapper.1
            @Override // io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.Module.SetupContext
            ...
            public void registerSubtypes(Class... clsArr) {
                ObjectMapper.this.registerSubtypes((Class<?>[]) clsArr);
            }
            ...
            public void registerSubtypes(Collection collection) {
                ObjectMapper.this.registerSubtypes((Collection<Class<?>>) collection);
            }
    ...
    private static ServiceLoader secureGetServiceLoader(final Class cls, final ClassLoader classLoader) {
        if (System.getSecurityManager() == null) {
            return classLoader == null ? ServiceLoader.load(cls) : ServiceLoader.load(cls, classLoader);
        }
        return (ServiceLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ObjectMapper.2
    ...
    protected JsonNode _readTreeAndClose(JsonParser jsonParser) throws IOException {
        ...
        try {
            ...
            JsonDeserializer<Object> jsonDeserializer_findRootDeserializer = _findRootDeserializer(defaultDeserializationContextCreateDeserializationContext, javaType);
            if (deserializationConfig.useRootWrapping()) {
                obj_unwrapAndDeserialize = _unwrapAndDeserialize(jsonParser, defaultDeserializationContextCreateDeserializationContext, deserializationConfig, javaType, jsonDeserializer_findRootDeserializer);
            } else {
                Object objDeserialize = jsonDeserializer_findRootDeserializer.deserialize(jsonParser, defaultDeserializationContextCreateDeserializationContext);
                if (deserializationConfig.isEnabled(DeserializationFeature.FAIL_ON_TRAILING_TOKENS)) {
                    _verifyNoTrailingTokens(jsonParser, defaultDeserializationContextCreateDeserializationContext, javaType);
                }
                obj_unwrapAndDeserialize = objDeserialize;
            }
            JsonNode jsonNode = (JsonNode) obj_unwrapAndDeserialize;
            jsonParser.close();
            return jsonNode;
        } catch (Throwable th) {
            try {
