...
public final class ObservableWindow<T> extends AbstractObservableWithUpstream {
    ...
    static final class WindowExactObserver extends AtomicInteger implements Observer, Disposable, Runnable {
        ...
        public void onNext(Object obj) {
            ...
            if (unicastSubjectCreate != null) {
                unicastSubjectCreate.onNext(obj);
                long j = this.size + 1;
                this.size = j;
                if (j >= this.count) {
                    this.size = 0L;
    ...
    static final class WindowSkipObserver extends AtomicBoolean implements Observer, Disposable, Runnable {
