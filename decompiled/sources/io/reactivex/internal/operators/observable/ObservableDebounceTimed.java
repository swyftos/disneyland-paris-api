...
public final class ObservableDebounceTimed<T> extends AbstractObservableWithUpstream {
    ...
    static final class DebounceTimedObserver implements Observer, Disposable {
        boolean done;
