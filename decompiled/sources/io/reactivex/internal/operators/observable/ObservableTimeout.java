...
public final class ObservableTimeout<T, U, V> extends AbstractObservableWithUpstream {
    ...
    static final class TimeoutObserver extends AtomicLong implements Observer, Disposable, TimeoutSelectorSupport {
    ...
    static final class TimeoutFallbackObserver extends AtomicReference implements Observer, Disposable, TimeoutSelectorSupport {
    ...
    static final class TimeoutConsumer extends AtomicReference implements Observer, Disposable {
