...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractObservableWithUpstream {
    ...
    static final class GroupJoinDisposable extends AtomicInteger implements Disposable, JoinSupport {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        try {
                            ...
                            if (((Throwable) this.error.get()) != null) {
                                ...
                                try {
                                    observer.onNext(ObjectHelper.requireNonNull(this.resultSelector.apply(objPoll, unicastSubjectCreate), "The resultSelector returned a null value"));
    ...
    static final class LeftRightObserver extends AtomicReference implements Observer, Disposable {
    ...
    static final class LeftRightEndObserver extends AtomicReference implements Observer, Disposable {
        private static final long serialVersionUID = 1883890389173668373L;
        final int index;
        final boolean isLeft;
        final JoinSupport parent;
