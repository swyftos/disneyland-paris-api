...
public final class ObservableTakeUntilPredicate<T> extends AbstractObservableWithUpstream {
    ...
    static final class TakeUntilPredicateObserver implements Observer, Disposable {
        boolean done;
