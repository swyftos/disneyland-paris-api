...
public final class ObservableConcatMapSingle<T, R> extends Observable<R> {
    ...
    static final class ConcatMapSingleMainObserver extends AtomicInteger implements Observer, Disposable {
        ...
        ConcatMapSingleMainObserver(Observer observer, Function function, int i, ErrorMode errorMode) {
        ...
        */
        void drain() {
            ...
            L5d:
                ...
                r10.state = r4
                io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver$ConcatMapSingleObserver r7 = r10.inner
                r6.subscribe(r7)
                goto L98
            L73:
                r1 = move-exception
        ...
        static final class ConcatMapSingleObserver extends AtomicReference implements SingleObserver {
            ...
            final ConcatMapSingleMainObserver parent;
