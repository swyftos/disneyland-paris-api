...
public final class FlowableZipIterable<T, U, V> extends AbstractFlowableWithUpstream {
        ...
        try {
            ...
            try {
                if (!it.hasNext()) {
                    ...
                    this.source.subscribe((FlowableSubscriber<? super Object>) new ZipIterableSubscriber(subscriber, it, this.zipper));
                }
            } catch (Throwable th) {
    ...
    static final class ZipIterableSubscriber implements FlowableSubscriber, Subscription {
        boolean done;
