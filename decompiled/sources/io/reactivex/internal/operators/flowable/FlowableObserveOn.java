...
public final class FlowableObserveOn<T> extends AbstractFlowableWithUpstream {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        if (subscriber instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber<? super Object>) new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, workerCreateWorker, this.delayError, this.prefetch));
        } else {
            this.source.subscribe((FlowableSubscriber<? super Object>) new ObserveOnSubscriber(subscriber, workerCreateWorker, this.delayError, this.prefetch));
        }
    }

    static abstract class BaseObserveOnSubscriber extends BasicIntQueueSubscription implements FlowableSubscriber, Runnable {
    ...
    static final class ObserveOnSubscriber extends BaseObserveOnSubscriber implements FlowableSubscriber {
        ...
        public Object poll() throws Exception {
            ...
            if (objPoll != null && this.sourceMode != 1) {
    ...
    static final class ObserveOnConditionalSubscriber extends BaseObserveOnSubscriber {
                ...
                while (j != j2) {
                    try {
                        ...
                        if (objPoll == null) {
                            ...
                            this.worker.dispose();
                            return;
                        } else if (conditionalSubscriber.tryOnNext(objPoll)) {
                            j++;
                        }
                    } catch (Throwable th) {
                        Exceptions.throwIfFatal(th);
