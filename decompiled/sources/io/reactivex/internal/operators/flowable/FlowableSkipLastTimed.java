...
public final class FlowableSkipLastTimed<T> extends AbstractFlowableWithUpstream {
    ...
    protected void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new SkipLastTimedSubscriber(subscriber, this.time, this.unit, this.scheduler, this.bufferSize, this.delayError));
    }

    static final class SkipLastTimedSubscriber extends AtomicInteger implements FlowableSubscriber, Subscription {
