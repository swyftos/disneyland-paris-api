...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber implements ConditionalSubscriber, Subscription {
        boolean done;
        ...
        public boolean tryOnNext(Object obj) {
            ...
            do {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.apply(obj), "The mapper returned a null value"));
                    return true;
                } catch (Throwable th) {
    ...
    static final class ParallelMapTryConditionalSubscriber implements ConditionalSubscriber, Subscription {
        boolean done;
        ...
        public boolean tryOnNext(Object obj) {
            ...
            do {
                try {
                    return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.apply(obj), "The mapper returned a null value"));
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    try {
                        j++;
