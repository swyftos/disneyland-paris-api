...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    protected void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        try {
            ...
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.sourceSupplier.apply(objCall), "The sourceSupplier returned a null MaybeSource")).subscribe(new UsingObserver(maybeObserver, objCall, this.resourceDisposer, this.eager));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                if (this.eager) {
                    try {
                        this.resourceDisposer.accept(objCall);
                    } catch (Throwable th2) {
    ...
    static final class UsingObserver extends AtomicReference implements MaybeObserver, Disposable {
