...
public final class MaybeSubject<T> extends Maybe<T> implements MaybeObserver<T> {
    ...
    boolean add(MaybeDisposable maybeDisposable) {
    ...
    void remove(MaybeDisposable maybeDisposable) {
        MaybeDisposable[] maybeDisposableArr;
        MaybeDisposable[] maybeDisposableArr2;
        do {
            maybeDisposableArr = (MaybeDisposable[]) this.observers.get();
    ...
    static final class MaybeDisposable extends AtomicReference implements Disposable {
