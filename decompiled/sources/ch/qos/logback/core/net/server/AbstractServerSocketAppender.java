...
public abstract class AbstractServerSocketAppender<E> extends AppenderBase<E> {
    ...
    protected void append(E e) {
        ...
        this.runner.accept(new ClientVisitor() { // from class: ch.qos.logback.core.net.server.AbstractServerSocketAppender.1
    ...
    public void start() {
        ...
        try {
            ServerRunner<RemoteReceiverClient> serverRunnerCreateServerRunner = createServerRunner(createServerListener(getServerSocketFactory().createServerSocket(getPort(), getBacklog(), getInetAddress())), getContext().getScheduledExecutorService());
