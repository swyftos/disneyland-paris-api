...
import com.appdynamics.repacked.gson.FieldNamingStrategy;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(final Gson gson, Field field, final Method method, String str, final TypeToken typeToken, boolean z, boolean z2, final boolean z3) {
        ...
        return new BoundField(str, field, z, z2) { // from class: com.appdynamics.repacked.gson.internal.bind.ReflectiveTypeAdapterFactory.1
            @Override // com.appdynamics.repacked.gson.internal.bind.ReflectiveTypeAdapterFactory.BoundField
    ...
    private Map getBoundFields(Gson gson, TypeToken typeToken, Class cls, boolean z, boolean z2) throws SecurityException, JsonIOException {
        boolean z3;
        Method method;
        int i;
        int i2;
            ...
            while (i3 < length) {
                ...
                if (zIncludeField || zIncludeField2) {
                    ...
                    while (i4 < size) {
                        ...
                        boolean z9 = i4 != 0 ? z7 : zIncludeField;
                        int i5 = i4;
    ...
    private static final class FieldReflectionAdapter extends Adapter {
        ...
        @Override // com.appdynamics.repacked.gson.internal.bind.ReflectiveTypeAdapterFactory.Adapter
    ...
    private static final class RecordAdapter extends Adapter {
        ...
        RecordAdapter(Class cls, Map map, boolean z) throws SecurityException, JsonIOException {
            super(map);
