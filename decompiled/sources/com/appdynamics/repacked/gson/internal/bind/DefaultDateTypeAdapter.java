...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        public static final DateType<Date> DATE = new DateType(Date.class) { // from class: com.appdynamics.repacked.gson.internal.bind.DefaultDateTypeAdapter.DateType.1
