package com.appdynamics.repacked.gson.internal.reflect;
...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) throws SecurityException, JsonIOException {
        try {
    ...
    public static String getAccessibleObjectDescription(AccessibleObject accessibleObject, boolean z) {
        ...
        if (accessibleObject instanceof Field) {
            ...
            str = "method '" + method.getDeclaringClass().getName() + GherkinLanguageConstants.COMMENT_PREFIX + sb.toString() + "'";
    ...
    public static String fieldToString(Field field) {
        return field.getDeclaringClass().getName() + GherkinLanguageConstants.COMMENT_PREFIX + field.getName();
    }
    ...
    private static class RecordSupportedHelper extends RecordHelper {
        ...
        @Override // com.appdynamics.repacked.gson.internal.reflect.ReflectionHelper.RecordHelper
