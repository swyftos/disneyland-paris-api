...
public final class JsonConfig$InAppConfig$$serializer implements GeneratedSerializer<JsonConfig.InAppConfig> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.InAppConfig", jsonConfig$InAppConfig$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement("activation_key", true);
    ...
    public JsonConfig.InAppConfig deserialize(Decoder decoder) {
        ...
        return new JsonConfig.InAppConfig(i, strDecodeStringElement, zDecodeBooleanElement, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.InAppConfig value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.InAppConfig.write$Self(value, compositeEncoderBeginStructure, descriptor2);
