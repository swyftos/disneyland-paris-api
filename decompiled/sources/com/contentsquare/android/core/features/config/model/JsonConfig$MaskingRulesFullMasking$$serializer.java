...
public final class JsonConfig$MaskingRulesFullMasking$$serializer implements GeneratedSerializer<JsonConfig.MaskingRulesFullMasking> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.MaskingRulesFullMasking", jsonConfig$MaskingRulesFullMasking$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement(TCEventPropertiesNames.TCA_APP, true);
        pluginGeneratedSerialDescriptor.addElement("sdk", true);
        pluginGeneratedSerialDescriptor.addElement("flutter_plugin", true);
    ...
    public KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = JsonConfig.MaskingRulesFullMasking.$childSerializers;
        return new KSerializer[]{kSerializerArr[0], kSerializerArr[1], kSerializerArr[2]};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public JsonConfig.MaskingRulesFullMasking deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            Object objDecodeSerializableElement5 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, kSerializerArr[1], null);
            objDecodeSerializableElement3 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, kSerializerArr[2], null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeSerializableElement6 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, kSerializerArr[2], objDecodeSerializableElement6);
                    i2 |= 4;
                }
            }
            i = i2;
        ...
        return new JsonConfig.MaskingRulesFullMasking(i, (List) objDecodeSerializableElement2, (List) objDecodeSerializableElement, (List) objDecodeSerializableElement3, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.MaskingRulesFullMasking value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.MaskingRulesFullMasking.write$Self(value, compositeEncoderBeginStructure, descriptor2);
