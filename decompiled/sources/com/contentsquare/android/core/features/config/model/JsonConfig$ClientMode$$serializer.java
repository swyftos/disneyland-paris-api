...
public final class JsonConfig$ClientMode$$serializer implements GeneratedSerializer<JsonConfig.ClientMode> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.ClientMode", jsonConfig$ClientMode$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement("snapshot", false);
        pluginGeneratedSerialDescriptor.addElement("snapshot_endpoint", false);
    ...
    public JsonConfig.ClientMode deserialize(Decoder decoder) {
        ...
        return new JsonConfig.ClientMode(i, zDecodeBooleanElement, strDecodeStringElement, null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.ClientMode value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.ClientMode.write$Self(value, compositeEncoderBeginStructure, descriptor2);
