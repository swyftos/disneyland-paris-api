...
public final class JsonConfig$ApiErrorsV2$CustomHeader$$serializer implements GeneratedSerializer<JsonConfig.ApiErrorsV2.CustomHeader> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.ApiErrorsV2.CustomHeader", jsonConfig$ApiErrorsV2$CustomHeader$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("header_name", false);
    ...
    public JsonConfig.ApiErrorsV2.CustomHeader deserialize(Decoder decoder) {
        ...
        return new JsonConfig.ApiErrorsV2.CustomHeader(i, str, z, strDecodeStringElement, null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.ApiErrorsV2.CustomHeader value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.ApiErrorsV2.CustomHeader.write$Self(value, compositeEncoderBeginStructure, descriptor2);
