...
public final class JsonConfig$WebView$$serializer implements GeneratedSerializer<JsonConfig.WebView> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.WebView", jsonConfig$WebView$$serializer, 1);
        pluginGeneratedSerialDescriptor.addElement("tag_id", true);
    ...
    public JsonConfig.WebView deserialize(Decoder decoder) {
        ...
        return new JsonConfig.WebView(i, (String) objDecodeNullableSerializableElement, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.WebView value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.WebView.write$Self(value, compositeEncoderBeginStructure, descriptor2);
