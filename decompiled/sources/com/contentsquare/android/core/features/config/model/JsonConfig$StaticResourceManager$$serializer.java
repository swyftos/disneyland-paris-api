...
public final class JsonConfig$StaticResourceManager$$serializer implements GeneratedSerializer<JsonConfig.StaticResourceManager> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.contentsquare.android.core.features.config.model.JsonConfig.StaticResourceManager", jsonConfig$StaticResourceManager$$serializer, 2);
    ...
    public JsonConfig.StaticResourceManager deserialize(Decoder decoder) {
        ...
        return new JsonConfig.StaticResourceManager(i, zDecodeBooleanElement, strDecodeStringElement, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, JsonConfig.StaticResourceManager value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        JsonConfig.StaticResourceManager.write$Self(value, compositeEncoderBeginStructure, descriptor2);
