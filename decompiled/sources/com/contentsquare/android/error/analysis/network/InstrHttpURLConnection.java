...
public final class InstrHttpURLConnection extends HttpURLConnection {
    ...
    public InstrHttpURLConnection(HttpURLConnection connection, NetworkEventBuilder builder, ErrorAnalysis errorAnalysis) {
        super(connection.getURL());
        Intrinsics.checkNotNullParameter(connection, "connection");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Intrinsics.checkNotNullParameter(errorAnalysis, "errorAnalysis");
        this.delegate = new InstrURLConnectionBase(connection, builder, errorAnalysis);
    }
