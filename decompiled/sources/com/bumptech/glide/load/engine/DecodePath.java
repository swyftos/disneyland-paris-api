...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    public Resource<Transcode> decode(DataRewinder<DataType> dataRewinder, int i, int i2, @NonNull Options options, DecodeCallback decodeCallback) throws GlideException {
