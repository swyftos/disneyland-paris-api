...
public class Registry {
    ...
    public Registry() {
        Pools.Pool poolThreadSafeList = FactoryPools.threadSafeList();
        this.throwableListPool = poolThreadSafeList;
        this.modelLoaderRegistry = new ModelLoaderRegistry((Pools.Pool<List<Throwable>>) poolThreadSafeList);
