...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
