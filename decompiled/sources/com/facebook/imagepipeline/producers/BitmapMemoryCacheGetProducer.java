...
public final class BitmapMemoryCacheGetProducer extends BitmapMemoryCacheProducer {
    ...
    @NotNull
    protected Consumer<CloseableReference<CloseableImage>> wrapConsumer(@NotNull Consumer<CloseableReference<CloseableImage>> consumer, @NotNull CacheKey cacheKey, boolean isMemoryCacheEnabled) {
