...
public class GingerbreadPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    private static MemoryFile copyToMemoryFile(CloseableReference closeableReference, int i, byte[] bArr) throws Throwable {
    ...
    private Bitmap decodeFileDescriptorAsPurgeable(CloseableReference closeableReference, int i, byte[] bArr, BitmapFactory.Options options) throws Throwable {
