...
public class ImageRequest {
    public static final Fn<ImageRequest, Uri> REQUEST_TO_URI_FN = new Fn() { // from class: com.facebook.imagepipeline.request.ImageRequest.1
