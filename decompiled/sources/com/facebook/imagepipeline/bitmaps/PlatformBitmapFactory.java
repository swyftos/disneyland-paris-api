...
public abstract class PlatformBitmapFactory {
    ...
    private CloseableReference createBitmap(int i, int i2, Bitmap.Config config, boolean z, Object obj) {
        return createBitmap((DisplayMetrics) null, i, i2, config, z, obj);
    }

    private CloseableReference createBitmap(DisplayMetrics displayMetrics, int i, int i2, Bitmap.Config config, boolean z, Object obj) {
        checkWidthHeight(i, i2);
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        if (i != 1) {
            return i != 2 ? config : Bitmap.Config.ALPHA_8;
        }
