...
public interface BitmapMemoryCacheFactory {
    @NotNull
    CountingMemoryCache<CacheKey, CloseableImage> create(@NotNull Supplier<MemoryCacheParams> bitmapMemoryCacheParamsSupplier, @NotNull MemoryTrimmableRegistry memoryTrimmableRegistry, @NotNull MemoryCache.CacheTrimStrategy trimStrategy, boolean storeEntrySize, boolean ignoreSizeMismatch, @Nullable CountingMemoryCache.EntryStateObserver<CacheKey> observer);
}
