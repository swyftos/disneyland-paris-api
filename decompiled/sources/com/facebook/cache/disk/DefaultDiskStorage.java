...
public class DefaultDiskStorage implements DiskStorage {
    ...
    private void mkdirs(File file, String str) throws FileUtils.CreateDirectoryException {
        try {
    ...
    private String typeOfBytes(byte[] bArr) {
        if (bArr.length >= 2) {
            byte b = bArr[0];
            if (b == -1 && bArr[1] == -40) {
                return MapModule.SNAPSHOT_FORMAT_JPG;
            }
            if (b == -119 && bArr[1] == 80) {
                return MapModule.SNAPSHOT_FORMAT_PNG;
            }
            if (b == 82 && bArr[1] == 73) {
                return "webp";
            }
    ...
    private static class FileInfo {
        ...
        public File createTempFile(File file) {
            return File.createTempFile(this.resourceId + InstructionFileId.DOT, FileType.TEMP, file);
        }
    ...
    class InserterImpl implements DiskStorage.Inserter {
        ...
        @Override // com.facebook.cache.disk.DiskStorage.Inserter
        public BinaryResource commit(Object obj, long j) throws FileUtils.RenameException {
