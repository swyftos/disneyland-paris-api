...
public class NativeAnimatedNodesManager implements EventDispatcherListener {
    ...
    @UiThread
    public void startAnimatingNode(int i, int i2, ReadableMap readableMap, @Nullable Callback callback) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (animatedNode5.children != null) {
                for (int i15 = 0; i15 < animatedNode5.children.size(); i15++) {
                    ...
                    int i16 = animatedNode6.activeIncomingNodes - 1;
                    animatedNode6.activeIncomingNodes = i16;
                    int i17 = animatedNode6.BFSColor;
                    int i18 = this.mAnimatedGraphBFSColor;
                    if (i17 != i18 && i16 == 0) {
                        animatedNode6.BFSColor = i18;
                        i11++;
