...
public abstract class ReactBaseTextShadowNode extends LayoutShadowNode {
    ...
    private static void buildSpannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, SpannableStringBuilder spannableStringBuilder, List<SetSpanOperation> list, @Nullable TextAttributes textAttributes, boolean z, @Nullable Map<Integer, ReactShadowNode> map, int i) {
        ...
        if (length >= i) {
            ...
            if ((reactBaseTextShadowNode.mTextShadowOffsetDx != BitmapDescriptorFactory.HUE_RED || reactBaseTextShadowNode.mTextShadowOffsetDy != BitmapDescriptorFactory.HUE_RED || reactBaseTextShadowNode.mTextShadowRadius != BitmapDescriptorFactory.HUE_RED) && Color.alpha(reactBaseTextShadowNode.mTextShadowColor) != 0) {
    ...
    protected Spannable spannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, @Nullable String str, boolean z, NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        int height;
    ...
    public ReactBaseTextShadowNode(@Nullable ReactTextViewManagerCallback reactTextViewManagerCallback) {
        ...
        this.mMinimumFontScale = BitmapDescriptorFactory.HUE_RED;
        this.mFontStyle = -1;
        this.mFontWeight = -1;
