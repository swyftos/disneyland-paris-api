...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    public JSPackagerClient(String str, PackagerConnectionSettings packagerConnectionSettings, Map<String, RequestHandler> map, @Nullable ReconnectingWebSocket.ConnectionCallback connectionCallback) {
        ...
        builder.scheme("ws").encodedAuthority(packagerConnectionSettings.getDebugServerHost()).appendPath("message").appendQueryParameter("device", AndroidInfoHelpers.getFriendlyDeviceName()).appendQueryParameter(TCEventPropertiesNames.TCA_APP, packagerConnectionSettings.getPackageName()).appendQueryParameter("clientid", str);
