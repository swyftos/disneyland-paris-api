...
class ViewManagersPropertyCache {
    ...
    private static PropSetter createPropSetter(ReactProp reactProp, Method method, Class<?> cls) {
        ...
        throw new RuntimeException("Unrecognized type: " + cls + " for method: " + method.getDeclaringClass().getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
    }
        ...
        for (Method method : cls.getDeclaredMethods()) {
            ...
            if (reactProp != null) {
                ...
                if (parameterTypes.length != 2) {
                    throw new RuntimeException("Wrong number of args for prop setter: " + cls.getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
                }
                if (!View.class.isAssignableFrom(parameterTypes[0])) {
                    throw new RuntimeException("First param should be a view subclass to be updated: " + cls.getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
                }
            ...
            if (reactPropGroup != null) {
                ...
                if (parameterTypes2.length != 3) {
                    throw new RuntimeException("Wrong number of args for group prop setter: " + cls.getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
                }
                if (!View.class.isAssignableFrom(parameterTypes2[0])) {
                    throw new RuntimeException("First param should be a view subclass to be updated: " + cls.getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
                }
                if (parameterTypes2[1] != Integer.TYPE) {
                    throw new RuntimeException("Second argument should be property index: " + cls.getName() + GherkinLanguageConstants.COMMENT_PREFIX + method.getName());
                }
