...
public final class BackgroundDrawable extends Drawable {
    ...
    private final RectF computeBorderInsets() {
        ...
        float fDpToPx = BitmapDescriptorFactory.HUE_RED;
        float fDpToPx2 = rectFResolve != null ? PixelUtil.INSTANCE.dpToPx(rectFResolve.left) : 0.0f;
        float fDpToPx3 = rectFResolve != null ? PixelUtil.INSTANCE.dpToPx(rectFResolve.top) : 0.0f;
        float fDpToPx4 = rectFResolve != null ? PixelUtil.INSTANCE.dpToPx(rectFResolve.right) : 0.0f;
