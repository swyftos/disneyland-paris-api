...
public class TransformHelper {
    ...
    public static void processTransform(ReadableArray readableArray, double[] dArr) {
        processTransform(readableArray, dArr, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, null, false);
    }
                    ...
                    if ("rotate".equals(strNextKey) || "rotateZ".equals(strNextKey)) {
                        ...
                        if ("translate".equals(strNextKey)) {
                            ...
                            if (array2.getType(i4) == readableType && z) {
                                translateValue4 = parseTranslateValue(array2.getString(i4), f2);
                            } else {
                                translateValue4 = array2.getDouble(i4);
                            }
                            i = i7;
                            double d2 = translateValue4;
                            i3 = i9;
                            i2 = 16;
                            MatrixMathHelper.applyTranslate3D(dArr2, translateValue3, d2, array2.size() > 2 ? array2.getDouble(2) : AudioStats.AUDIO_AMPLITUDE_NONE);
                        } else {
                            i = i7;
                            i3 = i9;
                            i2 = 16;
