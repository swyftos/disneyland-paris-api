...
public final /* data */ class BoxShadow {
    ...
    @NotNull
    public final BoxShadow copy(float offsetX, float offsetY, @ColorInt @Nullable Integer color, @Nullable Float blurRadius, @Nullable Float spreadDistance, @Nullable Boolean inset) {
