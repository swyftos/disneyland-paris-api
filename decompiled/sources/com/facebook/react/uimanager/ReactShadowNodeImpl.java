...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    private final Spacing mDefaultPadding = new Spacing(BitmapDescriptorFactory.HUE_RED);
    ...
    @Override // com.facebook.react.uimanager.ReactShadowNode
    public void dispatchUpdates(float f, float f2, UIViewOperationQueue uIViewOperationQueue, @Nullable NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        if (this.mNodeUpdated) {
