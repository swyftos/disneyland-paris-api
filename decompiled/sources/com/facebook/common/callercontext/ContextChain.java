...
public class ContextChain implements Parcelable {
    public static final Parcelable.Creator<ContextChain> CREATOR = new Parcelable.Creator() { // from class: com.facebook.common.callercontext.ContextChain.1
    ...
    private void initializeExtraData(ContextChain contextChain, Map map) {
