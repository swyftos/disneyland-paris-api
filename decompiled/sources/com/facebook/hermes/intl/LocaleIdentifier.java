...
public class LocaleIdentifier {
    private static void addVariantSubtag(String str, ParsedLocaleIdentifier.ParsedLanguageIdentifier parsedLanguageIdentifier) throws JSRangeErrorException {
        ArrayList arrayList = parsedLanguageIdentifier.variantSubtagList;
        if (arrayList != null) {
    ...
    static String canonicalizeLocaleId(String str) {
    ...
    static void parseTransformedExtensionFields(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, ParsedLocaleIdentifier parsedLocaleIdentifier) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
        if (localeIdSubtag.isTranformedExtensionTKey()) {
            TreeMap treeMap = parsedLocaleIdentifier.transformedExtensionFields;
            if (treeMap != null) {
    ...
    static void parseLanguageId(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z, ParsedLocaleIdentifier parsedLocaleIdentifier) throws JSRangeErrorException {
    ...
    static ParsedLocaleIdentifier parseLocaleId(String str) {
        int iBinarySearch;
        String[] strArr = LanguageTagsGenerated.regularGrandfatheredKeys;
        if (strArr != null && (iBinarySearch = Arrays.binarySearch(strArr, str.toString())) >= 0) {
