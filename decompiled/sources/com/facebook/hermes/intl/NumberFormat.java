...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map map) throws JSRangeErrorException {
        ...
        Object objGetOption5 = OptionHelpers.GetOption(map, "unitDisplay", optionType, new String[]{LongTypedProperty.TYPE, "short", "narrow"}, "short");
    ...
    private void setNumberFormatDigitOptions(Map map, Object obj, Object obj2) throws JSRangeErrorException {
    ...
    private void initializeNumberFormat(List list, Map map) throws JSRangeErrorException {
        Object objNewNumber;
        ...
        Object objGetOption2 = OptionHelpers.GetOption(map, "compactDisplay", optionType, new String[]{"short", LongTypedProperty.TYPE}, "short");
