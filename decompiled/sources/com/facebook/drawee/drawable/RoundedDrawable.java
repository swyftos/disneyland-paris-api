...
public abstract class RoundedDrawable extends Drawable implements Rounded, TransformAwareDrawable {
    ...
    protected void updateTransform() {
        ...
        this.mBitmapBounds.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getIntrinsicWidth(), getIntrinsicHeight());
    ...
    protected void updatePath() {
        ...
        if (this.mIsPathDirty) {
            ...
            this.mPath.reset();
            float f3 = this.mPadding + (this.mScaleDownInsideBorders ? this.mBorderWidth : BitmapDescriptorFactory.HUE_RED);
