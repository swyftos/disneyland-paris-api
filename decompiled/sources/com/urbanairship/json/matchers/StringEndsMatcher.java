...
public final class StringEndsMatcher extends ValueMatcher {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.to(STRING_ENDS, this.expected)).getJsonValue();
    ...
    protected boolean apply(@NotNull JsonValue value, boolean ignoreCase) {
        ...
        return StringsKt.endsWith(string2, string, ignoreCase);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual(StringEndsMatcher.class, other != null ? other.getClass() : null)) {
            return false;
        }
        Intrinsics.checkNotNull(other, "null cannot be cast to non-null type com.urbanairship.json.matchers.StringEndsMatcher");
        return Intrinsics.areEqual(this.expected, ((StringEndsMatcher) other).expected);
    }
