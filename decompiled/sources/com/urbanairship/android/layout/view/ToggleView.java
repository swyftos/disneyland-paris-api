...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0002¢\u0006\u0002\u0010\u0006J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0014J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\t\u001a\u00020\rH\u0014¨\u0006\u000e"}, d2 = {"Lcom/urbanairship/android/layout/view/ToggleView;", "Lcom/urbanairship/android/layout/widget/CheckableView;", "Lcom/urbanairship/android/layout/model/ToggleModel;", "context", "Landroid/content/Context;", TCEventPropertiesNames.TCD_MODEL, "(Landroid/content/Context;Lcom/urbanairship/android/layout/model/ToggleModel;)V", "createCheckboxView", "Lcom/urbanairship/android/layout/widget/ShapeButton;", "style", "Lcom/urbanairship/android/layout/property/CheckboxStyle;", "createSwitchView", "Landroidx/appcompat/widget/SwitchCompat;", "Lcom/urbanairship/android/layout/property/SwitchStyle;", "urbanairship-layout_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class ToggleView extends CheckableView<ToggleModel> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ToggleView(@NotNull Context context, @NotNull ToggleModel model) {
        super(context, model);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(model, "model");
        final Drawable background = getBackground();
        model.setListener$urbanairship_layout_release(new CheckableModel.Listener() { // from class: com.urbanairship.android.layout.view.ToggleView.1
            ...
            public void setEnabled(boolean enabled) {
                ToggleView.this.setEnabled(enabled);
            }

            @Override // com.urbanairship.android.layout.model.BaseModel.Listener
            public void setVisibility(boolean visible) {
                ToggleView.this.setVisibility(visible ? 0 : 8);
            }
            ...
            public void setBackground(@Nullable Background old, @NotNull Background background2) {
                ...
                LayoutUtils.updateBackground(ToggleView.this, background, old, background2);
            }
        });
    }
    ...
    protected SwitchCompat createSwitchView(@NotNull SwitchStyle style) {
        ...
        return new SwitchCompat(getContext()) { // from class: com.urbanairship.android.layout.view.ToggleView.createSwitchView.1
    ...
    protected ShapeButton createCheckboxView(@NotNull CheckboxStyle style) {
        ...
        return new ShapeButton(getContext(), selected.getShapes(), unselected.getShapes(), selected.getIcon(), unselected.getIcon()) { // from class: com.urbanairship.android.layout.view.ToggleView.createCheckboxView.1
