...
final class BaseFormController$1$3 extends SuspendLambda implements Function2 {
    int label;
    final /* synthetic */ BaseFormController this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BaseFormController$1$3(BaseFormController baseFormController, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new BaseFormController$1$3(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super State.Form> flowCollector = new FlowCollector() { // from class: com.urbanairship.android.layout.model.BaseFormController$1$3.1
                @Override // kotlinx.coroutines.flow.FlowCollector
                public final Object emit(State.Form form, Continuation continuation) {
                    baseFormController.handleFormUpdate(form);
