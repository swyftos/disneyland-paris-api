...
@Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lcom/urbanairship/android/layout/info/ImageButtonInfo;", "Lcom/urbanairship/android/layout/info/ButtonInfo;", "json", "Lcom/urbanairship/json/JsonMap;", "(Lcom/urbanairship/json/JsonMap;)V", MimeTypes.BASE_TYPE_IMAGE, "Lcom/urbanairship/android/layout/property/Image;", "getImage", "()Lcom/urbanairship/android/layout/property/Image;", "urbanairship-layout_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nViewInfo.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ViewInfo.kt\ncom/urbanairship/android/layout/info/ImageButtonInfo\n+ 2 JsonExtensions.kt\ncom/urbanairship/json/JsonExtensionsKt\n*L\n1#1,944:1\n44#2,15:945\n*S KotlinDebug\n*F\n+ 1 ViewInfo.kt\ncom/urbanairship/android/layout/info/ImageButtonInfo\n*L\n604#1:945,15\n*E\n"})
/* loaded from: classes5.dex */
public final class ImageButtonInfo extends ButtonInfo {
    private final Image image;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ImageButtonInfo(@NotNull JsonMap json) throws JsonException {
        JsonMap jsonMapOptMap;
        super(json);
        Intrinsics.checkNotNullParameter(json, "json");
        JsonValue jsonValue = json.get(MimeTypes.BASE_TYPE_IMAGE);
        if (jsonValue == null) {
            throw new JsonException("Missing required field: '" + MimeTypes.BASE_TYPE_IMAGE + CoreConstants.SINGLE_QUOTE_CHAR);
        }
        ...
        if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(String.class))) {
            ...
            if (!Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(JsonValue.class))) {
                throw new JsonException("Invalid type '" + JsonMap.class.getSimpleName() + "' for field '" + MimeTypes.BASE_TYPE_IMAGE + CoreConstants.SINGLE_QUOTE_CHAR);
            }
        ...
        Image imageFromJson = Image.fromJson(jsonMapOptMap);
        Intrinsics.checkNotNullExpressionValue(imageFromJson, "fromJson(...)");
        this.image = imageFromJson;
    }
