...
public final class CustomViewInfo extends ViewInfo implements View {
    ...
    public CustomViewInfo(@NotNull JsonMap json) throws JsonException {
        String strOptString;
        ...
        JsonValue jsonValue3 = json.get(CustomEvent.PROPERTIES);
        if (jsonValue3 == null) {
            jsonMap = null;
        } else {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                ...
                if (!Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(JsonValue.class))) {
                    throw new JsonException("Invalid type '" + JsonMap.class.getSimpleName() + "' for field '" + CustomEvent.PROPERTIES + CoreConstants.SINGLE_QUOTE_CHAR);
                }
                jsonMapOptMap = (JsonMap) jsonValue3.getJsonValue();
            }
            jsonMap = jsonMapOptMap;
        }
        this.properties = jsonMap == null ? JsonExtensionsKt.jsonMapOf(new Pair[0]) : jsonMap;
    }
