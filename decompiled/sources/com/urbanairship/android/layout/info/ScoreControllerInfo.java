...
public final class ScoreControllerInfo extends ViewGroupInfo<ItemInfo.ViewItemInfo> implements Controller, Validatable, Accessible {
    ...
    public ScoreControllerInfo(@NotNull JsonMap json) {
        super(null);
