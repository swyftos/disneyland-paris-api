...
public final class WebViewInfo extends ViewInfo implements View {
    ...
    public WebViewInfo(@NotNull JsonMap json) throws JsonException {
        String strOptString;
        super(null);
