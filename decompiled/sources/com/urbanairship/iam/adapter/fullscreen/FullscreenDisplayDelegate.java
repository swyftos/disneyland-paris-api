...
public final class FullscreenDisplayDelegate implements DelegatingDisplayAdapter.Delegate {
    ...
    public FullscreenDisplayDelegate(@NotNull InAppMessageDisplayContent.FullscreenContent displayContent, @Nullable AirshipCachedAssets airshipCachedAssets, @NotNull ActivityMonitor activityMonitor, @NotNull ActionRunner actionRunner) {
    ...
    public Object display(@NotNull Context context, @NotNull InAppMessageAnalyticsInterface inAppMessageAnalyticsInterface, @NotNull Continuation<? super DisplayResult> continuation) {
        Intent intentPutExtra = new Intent(context, (Class<?>) FullscreenActivity.class).setFlags(268435456).putExtra(InAppMessageActivity.EXTRA_DISPLAY_ARGS_LOADER, InAppDisplayArgsLoader.INSTANCE.newLoader(new InAppDisplayArgs(this.displayContent, this.assets, new InAppMessageDisplayListener(inAppMessageAnalyticsInterface, new ActiveTimer(this.activityMonitor, null, 2, null), new Function1() { // from class: com.urbanairship.iam.adapter.fullscreen.FullscreenDisplayDelegate$display$displayListener$1
            ...
            public final void invoke(DisplayResult it) {
                ...
                Continuation continuation2 = this.this$0.continuation;
                if (continuation2 != null) {
                    continuation2.resumeWith(Result.m2968constructorimpl(it));
                }
            }
    ...
    /* renamed from: com.urbanairship.iam.adapter.fullscreen.FullscreenDisplayDelegate$display$2, reason: invalid class name */
    static final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return FullscreenDisplayDelegate.this.new AnonymousClass2(this.$context, this.$intent, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FullscreenDisplayDelegate fullscreenDisplayDelegate = FullscreenDisplayDelegate.this;
                Context context = this.$context;
                Intent intent = this.$intent;
                this.L$0 = fullscreenDisplayDelegate;
                this.L$1 = context;
                this.L$2 = intent;
                this.label = 1;
                CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(this), 1);
                cancellableContinuationImpl.initCancellability();
                fullscreenDisplayDelegate.continuation = cancellableContinuationImpl;
