...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\b\u0018\u0000 \u00172\u00020\u0001:\u0001\u0017B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u000b\u001a\u00020\u0003HÆ\u0003J\t\u0010\f\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\r\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011HÖ\u0003J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\t\u0010\u0016\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0018"}, d2 = {"Lcom/urbanairship/contacts/AnonChannel;", "Lcom/urbanairship/json/JsonSerializable;", "channelId", "", "channelType", "Lcom/urbanairship/contacts/ChannelType;", "(Ljava/lang/String;Lcom/urbanairship/contacts/ChannelType;)V", "getChannelId", "()Ljava/lang/String;", "getChannelType", "()Lcom/urbanairship/contacts/ChannelType;", "component1", "component2", "copy", ExactValueMatcher.EQUALS_VALUE_KEY, "", ETCPaymentMethod.OTHER, "", "hashCode", "", "toJsonValue", "Lcom/urbanairship/json/JsonValue;", "toString", "Companion", "urbanairship-core_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final /* data */ class AnonChannel implements JsonSerializable {
    ...
    public static /* synthetic */ AnonChannel copy$default(AnonChannel anonChannel, String str, ChannelType channelType, int i, Object obj) {
        if ((i & 1) != 0) {
            str = anonChannel.channelId;
        }
        if ((i & 2) != 0) {
            channelType = anonChannel.channelType;
        }
        return anonChannel.copy(str, channelType);
    }
    ...
    @NotNull
    public final AnonChannel copy(@NotNull String channelId, @NotNull ChannelType channelType) {
        Intrinsics.checkNotNullParameter(channelId, "channelId");
        Intrinsics.checkNotNullParameter(channelType, "channelType");
        return new AnonChannel(channelId, channelType);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.channelId, anonChannel.channelId) && this.channelType == anonChannel.channelType;
    }
    ...
    public AnonChannel(@NotNull String channelId, @NotNull ChannelType channelType) {
        Intrinsics.checkNotNullParameter(channelId, "channelId");
        Intrinsics.checkNotNullParameter(channelType, "channelType");
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.to("channel_type", this.channelType.toString()), TuplesKt.to("channel_id", this.channelId)).getJsonValue();
        Intrinsics.checkNotNullExpressionValue(jsonValue, "toJsonValue(...)");
        return jsonValue;
    }

    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/urbanairship/contacts/AnonChannel$Companion;", "", "()V", "CHANNEL_ID_KEY", "", "CHANNEL_TYPE_KEY", "fromJson", "Lcom/urbanairship/contacts/AnonChannel;", "json", "Lcom/urbanairship/json/JsonValue;", "urbanairship-core_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    @SourceDebugExtension({"SMAP\nAnonContactData.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AnonContactData.kt\ncom/urbanairship/contacts/AnonChannel$Companion\n+ 2 JsonExtensions.kt\ncom/urbanairship/json/JsonExtensionsKt\n*L\n1#1,75:1\n44#2,15:76\n44#2,15:91\n*S KotlinDebug\n*F\n+ 1 AnonContactData.kt\ncom/urbanairship/contacts/AnonChannel$Companion\n*L\n69#1:76,15\n70#1:91,15\n*E\n"})
    public static final class Companion {
        ...
        @NotNull
        public final AnonChannel fromJson(@NotNull JsonValue json) throws JsonException {
            String strOptString;
            JsonValue jsonValue;
            Intrinsics.checkNotNullParameter(json, "json");
            JsonMap jsonMapRequireMap = json.requireMap();
            Intrinsics.checkNotNullExpressionValue(jsonMapRequireMap, "requireMap(...)");
            JsonValue jsonValue2 = jsonMapRequireMap.get("channel_id");
            if (jsonValue2 == null) {
            ...
            JsonValue jsonValue4 = jsonMapRequireMap2.get("channel_type");
            if (jsonValue4 == null) {
                throw new JsonException("Missing required field: 'channel_type" + CoreConstants.SINGLE_QUOTE_CHAR);
            }
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(String.class))) {
                ...
                if (!Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(JsonValue.class))) {
                    throw new JsonException("Invalid type '" + JsonValue.class.getSimpleName() + "' for field 'channel_type" + CoreConstants.SINGLE_QUOTE_CHAR);
                }
            ...
            return new AnonChannel(strOptString, companion.fromJson(jsonValue));
        }
    }
}
