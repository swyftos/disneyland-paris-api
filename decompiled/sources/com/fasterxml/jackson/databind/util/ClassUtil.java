...
public final class ClassUtil {
    ...
    private static void _addSuperTypes(JavaType javaType, Class cls, Collection collection, boolean z) {
        Class<?> rawClass;
    ...
    private static void _addRawSuperTypes(Class cls, Class cls2, Collection collection, boolean z) {
