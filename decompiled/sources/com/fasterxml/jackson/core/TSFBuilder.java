...
public abstract class TSFBuilder<F extends JsonFactory, B extends TSFBuilder<F, B>> {
    ...
    private TSFBuilder _failNonJSON(Object obj) {
        throw new IllegalArgumentException("Feature " + obj.getClass().getName() + GherkinLanguageConstants.COMMENT_PREFIX + obj.toString() + " not supported for non-JSON backend");
    }
