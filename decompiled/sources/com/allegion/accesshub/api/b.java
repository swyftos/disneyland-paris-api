...
final class b implements Interceptor {
    ...
    public final Response intercept(Interceptor.Chain chain) throws AlMAHException, IOException {
        ...
        try {
            ...
            MAHApiService mAHApiService = MAHApiService.INSTANCE;
            Intrinsics.checkExpressionValueIsNotNull(request, "request");
            alMAHHeaderBuilder.headerBuilder(builder, mAHApiService.determineHeaders$AccessHub_prodRelease(request), requestBodyBody == null ? null : buffer.readUtf8(), this.a);
            OkHttp3.Request.Builder.build.Enter(builder);
            Response response = chain.proceed(builder.build());
            Intrinsics.checkExpressionValueIsNotNull(response, "response");
            mAHApiService.a(response, this.a);
            return response;
