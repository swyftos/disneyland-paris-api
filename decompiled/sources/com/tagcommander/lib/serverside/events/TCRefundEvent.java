...
public class TCRefundEvent extends TCECommerceEvent {
    public String ID;
    ...
    public TCRefundEvent() {
        this.name = FirebaseAnalytics.Event.REFUND;
    }

    public TCRefundEvent(@NonNull String str, float f, float f2, @NonNull String str2, @NonNull String str3, @NonNull List<TCItem> list) {
        this();
        this.ID = str;
    ...
    public TCRefundEvent(@NonNull String str, float f, float f2, @NonNull String str2, @NonNull String str3) {
        this();
        this.ID = str;
        this.revenue = Float.valueOf(f);
        this.value = Float.valueOf(f2);
    ...
    public boolean verifyEvent() {
        return TCUtils.testString(this.ID) & TCUtils.testString(this.currency) & TCUtils.testString(this.type) & (this.revenue != null) & (this.value != null);
    }
    ...
    public JSONObject getJsonObject() throws JSONException {
        ...
        try {
            ...
            TCLogger.getInstance().logMessage("TCRefundEvent: Error putting information in JSON Object: " + e.getMessage(), 6);
        }
        return jsonObject;
    }
}
