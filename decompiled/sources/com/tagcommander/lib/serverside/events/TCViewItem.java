...
public class TCViewItem extends TCECommerceEvent {
    ...
    public TCViewItem(@NonNull List<TCItem> list) {
        this();
    ...
    public boolean verifyEvent() {
        ...
        if (this.revenue == null || testString(this.currency)) {
            return z;
        }
        return false;
    }
    ...
    public JSONObject getJsonObject() throws JSONException {
        ...
        try {
            ...
            TCLogger.getInstance().logMessage("TCViewItem: Error putting information in JSON Object: " + e.getMessage(), 6);
        }
        return jsonObject;
    }
}
