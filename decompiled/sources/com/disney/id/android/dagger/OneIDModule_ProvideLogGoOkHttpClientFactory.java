...
public final class OneIDModule_ProvideLogGoOkHttpClientFactory implements Factory<OkHttpClient> {
    ...
    public OkHttpClient get2() {
        return provideLogGoOkHttpClient(this.module, (Context) this.appContextProvider.get2());
    }
    ...
    public static OkHttpClient provideLogGoOkHttpClient(OneIDModule oneIDModule, Context context) {
        return (OkHttpClient) Preconditions.checkNotNullFromProvides(oneIDModule.provideLogGoOkHttpClient(context));
    }
}
