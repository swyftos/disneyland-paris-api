...
public class ClusterRendererMultipleItems<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private final MarkerCache mClusterMarkerCache;
    ...
    private final Queue ongoingAnimations = new LinkedList();
    private Set mMarkers = Collections.newSetFromMap(new ConcurrentHashMap());
    private final SparseArray mIcons = new SparseArray();
    ...
    public ClusterRendererMultipleItems(Context context, GoogleMap googleMap, ClusterManager<T> clusterManager) {
    ...
    public void onAdd() {
        this.mClusterManager.getMarkerCollection().setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.maps.GoogleMap.OnMarkerClickListener
            public final boolean onMarkerClick(Marker marker) {
                return this.f$0.lambda$onAdd$0(marker);
            }
        });
        this.mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.maps.GoogleMap.OnInfoWindowClickListener
            public final void onInfoWindowClick(Marker marker) {
                this.f$0.lambda$onAdd$1(marker);
            }
        });
        this.mClusterManager.getMarkerCollection().setOnInfoWindowLongClickListener(new GoogleMap.OnInfoWindowLongClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.maps.GoogleMap.OnInfoWindowLongClickListener
            public final void onInfoWindowLongClick(Marker marker) {
                this.f$0.lambda$onAdd$2(marker);
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.maps.GoogleMap.OnMarkerClickListener
            public final boolean onMarkerClick(Marker marker) {
                return this.f$0.lambda$onAdd$3(marker);
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda4
            @Override // com.google.android.gms.maps.GoogleMap.OnInfoWindowClickListener
            public final void onInfoWindowClick(Marker marker) {
                this.f$0.lambda$onAdd$4(marker);
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowLongClickListener(new GoogleMap.OnInfoWindowLongClickListener() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$$ExternalSyntheticLambda5
            @Override // com.google.android.gms.maps.GoogleMap.OnInfoWindowLongClickListener
            public final void onInfoWindowLongClick(Marker marker) {
    ...
    class ViewModifier extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            Projection projection = ClusterRendererMultipleItems.this.mMap.getProjection();
            synchronized (this) {
                renderTask = this.mNextClusters;
                this.mNextClusters = null;
                this.mViewModificationInProgress = true;
            }
            renderTask.setCallback(new Runnable() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$ViewModifier$$ExternalSyntheticLambda0
            ...
            renderTask.setMapZoom(ClusterRendererMultipleItems.this.mMap.getCameraPosition().zoom);
    ...
    private class RenderTask implements Runnable {
        ...
        public void setMapZoom(float f) {
            this.mMapZoom = f;
            this.mSphericalMercatorProjection = new SphericalMercatorProjection(Math.pow(2.0d, Math.min(f, ClusterRendererMultipleItems.this.mZoom)) * 256.0d);
        }
        ...
        public void run() {
            ...
            if (ClusterRendererMultipleItems.this.mClusters == null || !ClusterRendererMultipleItems.this.mAnimate) {
                ...
                for (Cluster<T> cluster : ClusterRendererMultipleItems.this.mClusters) {
                    if (ClusterRendererMultipleItems.this.shouldRenderAsCluster(cluster) && latLngBoundsBuild.contains(cluster.getPosition())) {
            ...
            if (ClusterRendererMultipleItems.this.mAnimate) {
                ...
                for (Cluster<T> cluster3 : this.clusters) {
                    if (ClusterRendererMultipleItems.this.shouldRenderAsCluster(cluster3) && latLngBoundsBuild.contains(cluster3.getPosition())) {
            ...
            for (MarkerWithPosition markerWithPosition : set) {
                ...
                if (zContains2 && ClusterRendererMultipleItems.this.mAnimate) {
                    ...
                    if (pointFindClosestCluster2 != null) {
                        ...
                        markerModifier.animateThenRemove(markerWithPosition, markerWithPosition.position, t.getPosition());
                    } else {
            ...
            ClusterRendererMultipleItems.this.mZoom = f;
            this.mCallback.run();
        }
    }
    ...
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        private final Queue mAnimationTasks;
        private final Queue mCreateMarkerTasks;
        private boolean mListenerAdded;
        private final Queue mOnScreenCreateMarkerTasks;
        private final Queue mOnScreenRemoveMarkerTasks;
        private final Queue mRemoveMarkerTasks;
        ...
        public void animate(MarkerWithPosition markerWithPosition, LatLng latLng, LatLng latLng2) {
            ...
            while (true) {
                ...
                if (animationTask2.marker.getId().equals(animationTask.marker.getId())) {
        ...
        private void performNextTask() {
            ...
            if (!this.mAnimationTasks.isEmpty()) {
                ...
                CreateMarkerTask createMarkerTask = (CreateMarkerTask) this.mOnScreenCreateMarkerTasks.poll();
                Objects.requireNonNull(createMarkerTask);
                createMarkerTask.perform(this);
            } else if (!this.mCreateMarkerTasks.isEmpty()) {
                CreateMarkerTask createMarkerTask2 = (CreateMarkerTask) this.mCreateMarkerTasks.poll();
                Objects.requireNonNull(createMarkerTask2);
                createMarkerTask2.perform(this);
            } else {
        ...
        private void removeMarker(Marker marker) {
            ClusterRendererMultipleItems.this.mMarkerCache.remove(marker);
            ClusterRendererMultipleItems.this.mClusterMarkerCache.remove(marker);
            ClusterRendererMultipleItems.this.mClusterManager.getMarkerManager().remove(marker);
        }
    ...
    private static class MarkerCache {
        ...
        private final Map mCacheReverse;
    ...
    private class CreateMarkerTask {
        ...
        public void perform(MarkerModifier markerModifier) {
            ...
            ClusterRendererMultipleItemsIA clusterRendererMultipleItemsIA = null;
            if (!ClusterRendererMultipleItems.this.shouldRenderAsCluster(this.cluster)) {
                for (T t : this.cluster.getItems()) {
                    Marker markerAddMarker = ClusterRendererMultipleItems.this.mMarkerCache.get(t);
                    ...
                    if (markerAddMarker == null) {
                        ...
                        } else if (ClusterRendererMultipleItems.this.mClusterMarkerCache.mCache.keySet().iterator().hasNext() && ((Cluster) ClusterRendererMultipleItems.this.mClusterMarkerCache.mCache.keySet().iterator().next()).getItems().contains(t)) {
                            Iterator it = ClusterRendererMultipleItems.this.mClusterMarkerCache.mCache.keySet().iterator();
                            T t2 = null;
                            while (it.hasNext()) {
                                Iterator<T> it2 = ((Cluster) it.next()).getItems().iterator();
                        ...
                        ClusterRendererMultipleItems.this.onBeforeClusterItemRendered(t, markerOptions);
                        markerAddMarker = ClusterRendererMultipleItems.this.mClusterManager.getMarkerCollection().addMarker(markerOptions);
                        markerWithPosition2 = new MarkerWithPosition(markerAddMarker, t);
                        ClusterRendererMultipleItems.this.mMarkerCache.put(t, markerAddMarker);
                        LatLng latLng2 = this.animateFrom;
                        if (latLng2 != null) {
                            markerModifier.animate(markerWithPosition2, latLng2, t.getPosition());
                        } else if (position != null) {
                            markerModifier.animate(markerWithPosition2, position, t.getPosition());
                        }
                    } else {
                        markerWithPosition2 = new MarkerWithPosition(markerAddMarker, t);
                        markerModifier.animate(markerWithPosition2, markerAddMarker.getPosition(), t.getPosition());
                    }
                    ClusterRendererMultipleItems.this.onClusterItemRendered(t, markerAddMarker);
                    this.newMarkers.add(markerWithPosition2);
                }
                return;
            }
            Marker markerAddMarker2 = ClusterRendererMultipleItems.this.mClusterMarkerCache.get(this.cluster);
            if (markerAddMarker2 == null) {
                MarkerOptions markerOptions2 = new MarkerOptions();
                LatLng position2 = this.animateFrom;
                if (position2 == null) {
                    position2 = this.cluster.getPosition();
                }
                MarkerOptions markerOptionsPosition = markerOptions2.position(position2);
                ClusterRendererMultipleItems.this.onBeforeClusterRendered(this.cluster, markerOptionsPosition);
                markerAddMarker2 = ClusterRendererMultipleItems.this.mClusterManager.getClusterMarkerCollection().addMarker(markerOptionsPosition);
                ClusterRendererMultipleItems.this.mClusterMarkerCache.put(this.cluster, markerAddMarker2);
                markerWithPosition = new MarkerWithPosition(markerAddMarker2, clusterRendererMultipleItemsIA);
                ...
                markerWithPosition = new MarkerWithPosition(markerAddMarker2, clusterRendererMultipleItemsIA);
                ClusterRendererMultipleItems.this.onClusterUpdated(this.cluster, markerAddMarker2);
            }
            ClusterRendererMultipleItems.this.onClusterRendered(this.cluster, markerAddMarker2);
            this.newMarkers.add(markerWithPosition);
        }
    }

    private static class MarkerWithPosition {
        private final Object clusterItem;
        private final Marker marker;
        private LatLng position;

        private MarkerWithPosition(Marker marker, Object obj) {
            this.marker = marker;
            this.clusterItem = obj;
    ...
    class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void perform() {
            ...
            valueAnimatorOfFloat.setInterpolator(ClusterRendererMultipleItems.ANIMATION_INTERP);
        ...
        public void cancel() {
            if (Looper.myLooper() != Looper.getMainLooper()) {
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.google.maps.android.clustering.view.ClusterRendererMultipleItems$AnimationTask$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.cancel();
                    }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            LatLng latLng3 = new LatLng(d4, (dSignum * d3) + this.from.longitude);
