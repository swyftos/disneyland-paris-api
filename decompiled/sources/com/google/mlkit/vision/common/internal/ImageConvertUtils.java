    ...
    public ByteBuffer convertToNv21Buffer(@NonNull InputImage inputImage, boolean z) throws MlKitException {
        ...
        for (int i4 = 0; i4 < height; i4++) {
            ...
            while (i5 < width) {
                ...
                int i11 = i7 & 255;
                int i12 = i8 & 255;
                byteBufferAllocate.put(i2, (byte) Math.min(255, (((((i11 * 66) + (i12 * TsExtractor.TS_STREAM_TYPE_AC3)) + (i9 * 25)) + 128) >> 8) + 16));
                if (i4 % 2 == 0 && i3 % 2 == 0) {
                    int i13 = ((((i11 * SyslogConstants.LOG_ALERT) - (i12 * 94)) - (i9 * 18)) + 128) >> 8;
                    int i14 = (((((i11 * (-38)) - (i12 * 74)) + (i9 * SyslogConstants.LOG_ALERT)) + 128) >> 8) + 128;
                    int i15 = i + 1;
