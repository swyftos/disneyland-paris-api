...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    */
    ...
    private static Pattern fpPattern() {
        return Pattern.compile(("[+-]?(?:NaN|Infinity|" + ("(?:\\d+#(?:\\.\\d*#)?|\\.\\d+#)(?:[eE][+-]?\\d+#)?[fFdD]?") + GherkinLanguageConstants.TABLE_CELL_SEPARATOR + ("0[xX](?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)[pP][+-]?\\d+#[fFdD]?") + ")").replace(GherkinLanguageConstants.COMMENT_PREFIX, Marker.ANY_NON_NULL_MARKER));
    }
