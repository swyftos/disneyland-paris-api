...
abstract class Types {
    ...
    private enum ClassOwnership {
        ...
        private static ClassOwnership detectJvmBehavior() {
            new C1LocalClass() { // from class: com.google.common.reflect.Types.ClassOwnership.3
            };
    ...
    static TypeVariable newArtificialTypeVariable(GenericDeclaration genericDeclaration, String str, Type... typeArr) {
        if (typeArr.length == 0) {
    ...
    private static TypeVariable newTypeVariableImpl(GenericDeclaration genericDeclaration, String str, Type[] typeArr) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Type[] toArray(Collection collection) {
        return (Type[]) collection.toArray(new Type[0]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static Iterable filterUpperBounds(Iterable iterable) {
  ...
  (r0v0 com.google.common.reflect.Types$JavaVersion) from 0x0063: SPUT (r0v0 com.google.common.reflect.Types$JavaVersion) (LINE:647) com.google.common.reflect.Types.JavaVersion.CURRENT com.google.common.reflect.Types$JavaVersion
    ...
    static abstract class JavaVersion {
        ...
        static {
            if (AnnotatedElement.class.isAssignableFrom(TypeVariable.class)) {
                if (new TypeCapture() { // from class: com.google.common.reflect.Types.JavaVersion.5
            ...
            if (new TypeCapture() { // from class: com.google.common.reflect.Types.JavaVersion.6
        ...
        final ImmutableList usedInGenericType(Type[] typeArr) {
