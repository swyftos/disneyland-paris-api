...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, MlKitException.CODE_SCANNER_PIPELINE_INFERENCE_ERROR, 169, 143, ErrorLogHelper.MAX_PROPERTY_ITEM_LENGTH, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, Currencies.DOP, 169, TsExtractor.TS_STREAM_TYPE_DTS_UHD, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long checkedPow(long j, int i) {
        ...
        while (i3 != 0) {
            ...
            int i4 = i3 >> 1;
            if (i4 > 0) {
                MathPreconditions.checkNoOverflow(-3037000499L <= j2 && j2 <= 3037000499L, "checkedPow", j2, i4);
                j2 *= j2;
            }
            i3 = i4;
            jCheckedMultiply = j3;
