...
enum BloomFilterStrategies implements BloomFilter.Strategy {
    MURMUR128_MITZ_32 { // from class: com.google.common.hash.BloomFilterStrategies.1
        ...
        public boolean put(Object obj, Funnel funnel, int i, LockFreeBitArray lockFreeBitArray) {
            long jBitSize = lockFreeBitArray.bitSize();
            long jAsLong = Hashing.murmur3_128().hashObject(obj, funnel).asLong();
            int i2 = (int) jAsLong;
        ...
        @Override // com.google.common.hash.BloomFilter.Strategy
        public boolean mightContain(Object obj, Funnel funnel, int i, LockFreeBitArray lockFreeBitArray) {
            long jBitSize = lockFreeBitArray.bitSize();
            long jAsLong = Hashing.murmur3_128().hashObject(obj, funnel).asLong();
            int i2 = (int) jAsLong;
            int i3 = (int) (jAsLong >>> 32);
