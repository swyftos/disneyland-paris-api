...
public final class ValueGraphBuilder<N, V> extends AbstractGraphBuilder {
    ...
    public <N1 extends N> ValueGraphBuilder<N1, V> nodeOrder(ElementOrder<N1> elementOrder) {
        ValueGraphBuilder<N1, V> valueGraphBuilderCast = cast();
        valueGraphBuilderCast.nodeOrder = (ElementOrder) Preconditions.checkNotNull(elementOrder);
        return valueGraphBuilderCast;
    }
    ...
    public <N1 extends N> ValueGraphBuilder<N1, V> incidentEdgeOrder(ElementOrder<N1> elementOrder) {
        ...
        ValueGraphBuilder<N1, V> valueGraphBuilderCast = cast();
        valueGraphBuilderCast.incidentEdgeOrder = (ElementOrder) Preconditions.checkNotNull(elementOrder);
        return valueGraphBuilderCast;
    }
