...
public final class ExecutionSequencer {
    ...
    public <T> ListenableFuture<T> submit(final Callable<T> callable, Executor executor) {
        ...
        return submitAsync(new AsyncCallable(this) { // from class: com.google.common.util.concurrent.ExecutionSequencer.1
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> asyncCallable, Executor executor) {
        ...
        final ListenableFuture listenableFuture = (ListenableFuture) this.ref.getAndSet(settableFutureCreate);
        final TrustedListenableFutureTask trustedListenableFutureTaskCreate = TrustedListenableFutureTask.create(asyncCallable2);
        listenableFuture.addListener(trustedListenableFutureTaskCreate, taskNonReentrantExecutor);
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.ExecutionSequencer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ExecutionSequencer.lambda$submitAsync$0(trustedListenableFutureTaskCreate, settableFutureCreate, listenableFuture, listenableFutureNonCancellationPropagating, taskNonReentrantExecutor);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    static final class TaskNonReentrantExecutor extends AtomicReference implements Executor, Runnable {
        Executor delegate;
