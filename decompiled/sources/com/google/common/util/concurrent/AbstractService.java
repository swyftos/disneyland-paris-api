...
public abstract class AbstractService implements Service {
    ...
    private static final ListenerCallQueue.Event STARTING_EVENT = new ListenerCallQueue.Event() { // from class: com.google.common.util.concurrent.AbstractService.1
    ...
    private static final ListenerCallQueue.Event RUNNING_EVENT = new ListenerCallQueue.Event() { // from class: com.google.common.util.concurrent.AbstractService.2
        @Override // com.google.common.util.concurrent.ListenerCallQueue.Event
        public void call(Service.Listener listener) {
            listener.running();
        }
    ...
    private static ListenerCallQueue.Event terminatedEvent(final Service.State state) {
        return new ListenerCallQueue.Event() { // from class: com.google.common.util.concurrent.AbstractService.3
            @Override // com.google.common.util.concurrent.ListenerCallQueue.Event
            public void call(Service.Listener listener) {
    ...
    private static ListenerCallQueue.Event stoppingEvent(final Service.State state) {
        return new ListenerCallQueue.Event() { // from class: com.google.common.util.concurrent.AbstractService.4
            @Override // com.google.common.util.concurrent.ListenerCallQueue.Event
            public void call(Service.Listener listener) {
    ...
    private void enqueueFailedEvent(final Service.State state, final Throwable th) {
        this.listeners.enqueue(new ListenerCallQueue.Event(this) { // from class: com.google.common.util.concurrent.AbstractService.5
            @Override // com.google.common.util.concurrent.ListenerCallQueue.Event
            public void call(Service.Listener listener) {
