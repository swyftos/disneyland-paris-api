...
class ObjectCountHashMap {
    ...
    void init(int i, float f) {
        ...
        Preconditions.checkArgument(f > BitmapDescriptorFactory.HUE_RED, "Illegal load factor");
    ...
    public int put(Object obj, int i) {
        ...
        if (i3 == -1) {
            ...
            while (true) {
                long j = jArr[i3];
                if (getHash(j) == iSmearedHash && Objects.equal(obj, objArr[i3])) {
                    int i4 = iArr[i3];
                    iArr[i3] = i;
                    return i4;
                }
        ...
        int i5 = i2 + 1;
        resizeMeMaybe(i5);
        insertEntry(i2, obj, i, iSmearedHash);
        this.size = i5;
    ...
    void insertEntry(int i, Object obj, int i2, int i3) {
        this.entries[i] = (i3 << 32) | BodyPartID.bodyIdMax;
        this.keys[i] = obj;
        this.values[i] = i2;
    }
    ...
    private void resizeTable(int i) {
        ...
        for (int i3 = 0; i3 < this.size; i3++) {
            ...
            iArrNewTable[i4] = i3;
            jArr[i3] = (hash << 32) | (i5 & BodyPartID.bodyIdMax);
        }
        this.threshold = i2;
