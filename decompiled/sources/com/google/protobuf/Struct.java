...
public final class Struct extends GeneratedMessageLite<Struct, Builder> implements StructOrBuilder {
    ...
    public Value getFieldsOrDefault(String str, Value value) {
        str.getClass();
        MapFieldLite mapFieldLiteInternalGetFields = internalGetFields();
        return mapFieldLiteInternalGetFields.containsKey(str) ? (Value) mapFieldLiteInternalGetFields.get(str) : value;
    }
    ...
    public Value getFieldsOrThrow(String str) {
        ...
        return (Value) mapFieldLiteInternalGetFields.get(str);
    }
