            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        UnsafeUtil.putByte(bArr, j4, (byte) ((cCharAt2 >>> '\f') | Currencies.MUR));
                        long j7 = j4 + 2;
                        ...
                        str3 = str5;
                        long j8 = j4 + j;
                        UnsafeUtil.putByte(bArr, j4, (byte) ((cCharAt2 >>> 6) | Currencies.XDR));
                        j4 += 2;
            ...
            while (i3 < length) {
                ...
                if (cCharAt2 >= c || jPosition >= jLimit) {
                    if (cCharAt2 >= 2048 || jPosition > jLimit - 2) {
                        ...
                        long j4 = jPosition + j;
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> '\f') | Currencies.MUR));
                        long j5 = jPosition + 2;
                        ...
                        j2 = jAddressOffset;
                        long j6 = jPosition + j;
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> 6) | Currencies.XDR));
                        jPosition += 2;
