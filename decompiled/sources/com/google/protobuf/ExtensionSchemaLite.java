...
final class ExtensionSchemaLite extends ExtensionSchema {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            ...
            if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
                ...
                if (generatedExtension.descriptor.getEnumType().findValueByNumber(int32) == null) {
                    return SchemaUtil.storeUnknownEnum(obj, number, int32, obj3, unknownFieldSchema);
                }
    ...
    @Override // com.google.protobuf.ExtensionSchema
    void parseMessageSetItem(ByteString byteString, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet) throws IOException {
        GeneratedMessageLite.GeneratedExtension generatedExtension = (GeneratedMessageLite.GeneratedExtension) obj;
