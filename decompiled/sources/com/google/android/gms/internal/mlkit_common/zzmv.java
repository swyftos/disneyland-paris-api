...
public enum zzmv implements zzba {
    ...
    ON_DEVICE_POSE_CLOSE(Currencies.GNF),
    ON_DEVICE_POSE_PRELOAD(325),
    ON_DEVICE_SEGMENTATION_CREATE(331),
    ON_DEVICE_SEGMENTATION_LOAD(Currencies.HTG),
    ...
    CUSTOM_OBJECT_CLOSE(Currencies.HKD),
    CUSTOM_IMAGE_LABEL_CREATE(351),
    CUSTOM_IMAGE_LABEL_LOAD(Currencies.ISK),
    ...
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(Currencies.DOP),
    ...
    INSTALLATION_ID_REGISTER_NEW_ID(Currencies.GIP),
    ...
    OPTIONAL_MODULE_NLCLASSIFIER_CREATE(Constants.FAILED_PRECONDITION_STATUS_CODE),
    OPTIONAL_MODULE_NLCLASSIFIER_INIT(413),
    OPTIONAL_MODULE_NLCLASSIFIER_INFERENCE(Currencies.KWD),
    ...
    OPTIONAL_MODULE_FACE_DETECTION_INIT(Currencies.MVR),
    ...
    TOXICITY_DETECTION_DOWNLOAD_EVENT(Currencies.MWK),
    ...
    OPTIONAL_MODULE_CUSTOM_IMAGE_LABELING_RELEASE(Currencies.MXN),
    ...
    OPTIONAL_MODULE_SMART_REPLY_RELEASE(Currencies.NPR),
    OPTIONAL_MODULE_TEXT_CREATE(531),
    OPTIONAL_MODULE_TEXT_INIT(Currencies.ANG),
    OPTIONAL_MODULE_TEXT_INFERENCE(Currencies.AWG),
    ...
    OPTIONAL_MODULE_DOCUMENT_DETECT_RELEASE(Currencies.NZD),
    ...
    ON_DEVICE_DOCUMENT_ENHANCE_CLOSE(Currencies.QAR),
    OPTIONAL_MODULE_IMAGE_LABELING_CREATE(641),
    OPTIONAL_MODULE_IMAGE_LABELING_INIT(642),
    OPTIONAL_MODULE_IMAGE_LABELING_INFERENCE(Currencies.RUB),
    ...
    SCANNER_AUTO_ZOOM_SCAN_FAILED(Currencies.SHP),
    ...
    ON_DEVICE_STAIN_REMOVAL_LOAD(Currencies.SAR),
    ...
    OPTIONAL_MODULE_STAIN_REMOVAL_CLOSE(Currencies.SLL),
    ...
    ON_DEVICE_SUBJECT_SEGMENTATION_LOAD(Currencies.SEK),
    ...
    OPTIONAL_MODULE_SUBJECT_SEGMENTATION_RELEASE(Currencies.THB);
