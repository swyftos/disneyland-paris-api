...
class MaterialCardViewHelper {
    ...
    private float checkedAnimationProgress = BitmapDescriptorFactory.HUE_RED;
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView, AttributeSet attributeSet, int i, int i2) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.CardView_cardCornerRadius)) {
            builder.setAllCornerSizes(typedArrayObtainStyledAttributes.getDimension(R.styleable.CardView_cardCornerRadius, BitmapDescriptorFactory.HUE_RED));
        }
    ...
    void updateContentPadding() {
        int iCalculateActualCornerPadding = (int) (((shouldAddCornerPaddingInsideCardBackground() || shouldAddCornerPaddingOutsideCardBackground()) ? calculateActualCornerPadding() : BitmapDescriptorFactory.HUE_RED) - getParentCardViewCalculatedCornerPadding());
    ...
    private float calculateVerticalBackgroundPadding() {
        return (this.materialCardView.getMaxCardElevation() * 1.5f) + (shouldAddCornerPaddingOutsideCardBackground() ? calculateActualCornerPadding() : BitmapDescriptorFactory.HUE_RED);
    }
    ...
    private float calculateCornerPaddingForCornerTreatment(CornerTreatment cornerTreatment, float f) {
        ...
        return cornerTreatment instanceof CutCornerTreatment ? f / 2.0f : BitmapDescriptorFactory.HUE_RED;
    }
    ...
    public void setChecked(boolean z, boolean z2) {
        ...
        if (drawable != null) {
            if (z2) {
                ...
                this.checkedAnimationProgress = z ? 1.0f : BitmapDescriptorFactory.HUE_RED;
            }
        }
    }
