...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.confirmButton, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.1
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(button, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void startPickerFragment() {
        ...
        MaterialCalendar materialCalendarNewInstance = MaterialCalendar.newInstance(getDateSelector(), themeResId, this.calendarConstraints, this.dayViewDecorator);
    ...
    private void initHeaderToggle(Context context) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.headerToggleButton, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
