...
public final class MaterialCalendar<S> extends PickerFragment {
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(materialButton, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                MaterialCalendar.this.toggleVisibleSelector();
            }
        });
        InstrumentationCallbacks.setOnClickListenerCalled(this.monthNext, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.monthPrev, new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
