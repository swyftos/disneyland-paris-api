...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(@NonNull Context context) {
        ...
        this.activeIndicatorProgress = BitmapDescriptorFactory.HUE_RED;
    ...
    public void setChecked(boolean z) {
        ...
        maybeAnimateActiveIndicatorToProgress(z ? 1.0f : BitmapDescriptorFactory.HUE_RED);
    ...
    private static class ActiveIndicatorTransform {
        ...
        protected float calculateAlpha(float f, float f2) {
            return AnimationUtils.lerp(BitmapDescriptorFactory.HUE_RED, 1.0f, f2 == BitmapDescriptorFactory.HUE_RED ? 0.8f : 0.0f, f2 == BitmapDescriptorFactory.HUE_RED ? 1.0f : 0.2f, f);
        }
