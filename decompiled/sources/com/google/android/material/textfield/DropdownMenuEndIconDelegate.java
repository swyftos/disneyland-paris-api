...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private void initAnimators() {
        this.fadeInAnim = getAlphaAnimator(this.animationFadeInDuration, BitmapDescriptorFactory.HUE_RED, 1.0f);
        ValueAnimator alphaAnimator = getAlphaAnimator(this.animationFadeOutDuration, 1.0f, BitmapDescriptorFactory.HUE_RED);
