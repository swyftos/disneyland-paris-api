...
public class ShapePath {
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        if (innerCornerShadowOperation.getSweepAngle() > BitmapDescriptorFactory.HUE_RED) {
            lineTo(f, f2);
            lineTo(f3, f4);
        } else {
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) Math.hypot(this.operation.y - this.startY, this.operation.x - this.startX), BitmapDescriptorFactory.HUE_RED);
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            if (sweepAngle > BitmapDescriptorFactory.HUE_RED) {
                return;
            }
            ...
            float f = 2.0f * fMin;
            RectF rectF2 = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, f, f);
            this.renderMatrix.set(matrix);
            ...
            if (dHypot2 > dTan) {
                ...
                this.renderMatrix.preTranslate((float) dTan, BitmapDescriptorFactory.HUE_RED);
