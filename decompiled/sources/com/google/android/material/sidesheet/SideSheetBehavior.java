...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet {
    ...
    public void setState(final int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout((View) this.viewRef.get(), new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda0
    ...
    public int calculateTargetStateOnViewReleased(View view, float f, float f2) {
        ...
        } else if (f == BitmapDescriptorFactory.HUE_RED || !SheetUtils.isSwipeMostlyHorizontal(f, f2)) {
    ...
    public void dispatchOnSlide(View view, int i) {
        ...
        Iterator it = this.callbacks.iterator();
        while (it.hasNext()) {
            ((SheetCallback) it.next()).onSlide(view, fCalculateSlideOffset);
        }
    }
    ...
    private void updateCoplanarSiblingBackProgress() {
        ...
        this.sheetDelegate.updateCoplanarSiblingAdjacentMargin(marginLayoutParams, (int) ((this.childWidth * view.getScaleX()) + this.innerMargin));
