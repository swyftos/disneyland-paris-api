...
abstract class SheetDialog extends AppCompatDialog {
    ...
    abstract void addSheetCancelOnHideCallback(Sheet sheet);

    abstract Sheet getBehaviorFromSheet(FrameLayout frameLayout);
    ...
    private void ensureContainerAndBehavior() {
        if (this.container == null) {
            ...
            Sheet behaviorFromSheet = getBehaviorFromSheet(frameLayout2);
    ...
    private View wrapInSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(coordinatorLayout.findViewById(TOUCH_OUTSIDE_ID), new View.OnClickListener() { // from class: com.google.android.material.sidesheet.SheetDialog$$ExternalSyntheticLambda0
