...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate {
    ...
    private void maybeInitializeAnimators() {
        if (this.animator == null) {
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, (Property<CircularIndeterminateAnimatorDelegate, Float>) ANIMATION_FRACTION, BitmapDescriptorFactory.HUE_RED, 1.0f);
        ...
        if (this.completeEndAnimator == null) {
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this, (Property<CircularIndeterminateAnimatorDelegate, Float>) COMPLETE_END_FRACTION, BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    void resetPropertiesForNewStart() {
        ...
        this.completeEndFraction = BitmapDescriptorFactory.HUE_RED;
    }
