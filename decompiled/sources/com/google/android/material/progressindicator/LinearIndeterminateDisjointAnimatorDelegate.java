...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate {
    ...
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {Currencies.AWG, 567, 850, 750};
    ...
    private void maybeInitializeAnimators() {
        if (this.animator == null) {
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, (Property<LinearIndeterminateDisjointAnimatorDelegate, Float>) ANIMATION_FRACTION, BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    private void updateSegmentPositions(int i) {
        for (int i2 = 0; i2 < this.activeIndicators.size(); i2++) {
            ...
            activeIndicator.startFraction = MathUtils.clamp(this.interpolatorArray[i3].getInterpolation(getFractionInRange(i, i4, iArr2[i3])), BitmapDescriptorFactory.HUE_RED, 1.0f);
            int i5 = i3 + 1;
            activeIndicator.endFraction = MathUtils.clamp(this.interpolatorArray[i5].getInterpolation(getFractionInRange(i, iArr[i5], iArr2[i5])), BitmapDescriptorFactory.HUE_RED, 1.0f);
        }
    }
