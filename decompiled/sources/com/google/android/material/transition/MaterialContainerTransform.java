...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final ProgressThresholdsGroup DEFAULT_ENTER_THRESHOLDS = new ProgressThresholdsGroup(new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.25f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.75f));
    ...
    static {
        DEFAULT_RETURN_THRESHOLDS = new ProgressThresholdsGroup(new ProgressThresholds(0.6f, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(0.3f, 0.9f));
        DEFAULT_RETURN_THRESHOLDS_ARC = new ProgressThresholdsGroup(new ProgressThresholds(0.6f, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(0.2f, 0.9f));
    }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.elevationShadowEnabled && this.currentElevation > BitmapDescriptorFactory.HUE_RED) {
        ...
        private void updateProgress(float f) {
            ...
            float f3;
            this.progress = f;
            this.scrimPaint.setAlpha((int) (this.entering ? TransitionUtils.lerp(BitmapDescriptorFactory.HUE_RED, 255.0f, f) : TransitionUtils.lerp(255.0f, BitmapDescriptorFactory.HUE_RED, f)));
            ...
            float fLerp = TransitionUtils.lerp(BitmapDescriptorFactory.HUE_RED, 1.0f, fFloatValue, fFloatValue2, f);
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
