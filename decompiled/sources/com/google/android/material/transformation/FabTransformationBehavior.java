...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float f, float f2, List list, List list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                animatorCreateCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget, fCalculateRevealCenterX, fCalculateRevealCenterY, MathUtils.distanceToFurthestCorner(fCalculateRevealCenterX, fCalculateRevealCenterY, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, f, f2));
    ...
    private float calculateTranslationY(View view, View view2, Positioning positioning) {
        ...
        calculateDependencyWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        int i = positioning.gravity & SyslogConstants.LOG_ALERT;
        if (i == 16) {
