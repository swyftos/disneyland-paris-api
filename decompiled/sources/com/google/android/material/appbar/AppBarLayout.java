...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public /* synthetic */ void lambda$initializeLiftOnScrollWithColor$0(ColorStateList colorStateList, ColorStateList colorStateList2, MaterialShapeDrawable materialShapeDrawable, Integer num, ValueAnimator valueAnimator) {
        ...
        for (LiftOnScrollListener liftOnScrollListener : this.liftOnScrollListeners) {
            if (materialShapeDrawable.getFillColor() != null) {
                liftOnScrollListener.onUpdate(BitmapDescriptorFactory.HUE_RED, iLayer);
            }
        }
    }
    ...
    boolean setLiftedState(boolean z, boolean z2) {
        ...
        boolean z3 = this.hasLiftOnScrollColor;
        ...
        float f3 = z ? 0.0f : this.appBarElevation;
        if (z) {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, appBarLayout, MathUtils.clamp(calculateSnapOffset(topBottomOffsetForScrollingSibling, minimumHeight, topInset2) + topInset, -appBarLayout.getTotalScrollRange(), 0), BitmapDescriptorFactory.HUE_RED);
                }
            }
        }
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i) {
            int iRound;
            boolean zOnLayoutChild = super.onLayoutChild(coordinatorLayout, (View) t, i);
            ...
            if (savedState == null || (pendingAction & 8) != 0) {
                if (pendingAction != 0) {
                    ...
                    if ((pendingAction & 2) != 0) {
                        ...
                        if (z) {
                            animateOffsetTo(coordinatorLayout, t, i2, BitmapDescriptorFactory.HUE_RED);
                        } else {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull Rect rect, boolean z) {
            AppBarLayout appBarLayoutFindFirstDependency = findFirstDependency((List) coordinatorLayout.getDependencies(view));
    ...
    public static class CompressChildScrollEffect extends ChildScrollEffect {
        ...
        public void onOffsetChanged(@NonNull AppBarLayout appBarLayout, @NonNull View view, float f) {
            ...
            if (fAbs <= BitmapDescriptorFactory.HUE_RED) {
                float fClamp = 1.0f - MathUtils.clamp(Math.abs(fAbs / this.relativeRect.height()), BitmapDescriptorFactory.HUE_RED, 1.0f);
