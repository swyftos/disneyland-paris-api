...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    public void setRevealFraction(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, to = 1.0d) float f) {
        ...
        this.labelOpacity = AnimationUtils.lerp(BitmapDescriptorFactory.HUE_RED, 1.0f, 0.19f, 1.0f, f);
        invalidateSelf();
    }
    ...
    private float getTextWidth() {
        CharSequence charSequence = this.text;
        return charSequence == null ? BitmapDescriptorFactory.HUE_RED : this.textDrawableHelper.getTextWidth(charSequence.toString());
    }
