...
class TimePickerView extends ConstraintLayout {
    ...
    private void setUpDisplay() {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(this.minuteView, this.selectionListener);
        InstrumentationCallbacks.setOnClickListenerCalled(this.hourView, this.selectionListener);
