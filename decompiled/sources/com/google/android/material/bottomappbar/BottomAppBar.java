...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.fabTransformationCallback = new TransformationCallback() { // from class: com.google.android.material.bottomappbar.BottomAppBar.2
            ...
            public void onScaleChanged(FloatingActionButton floatingActionButton) {
                BottomAppBar.this.materialShapeDrawable.setInterpolation((floatingActionButton.getVisibility() == 0 && BottomAppBar.this.fabAnchorMode == 1) ? floatingActionButton.getScaleY() : BitmapDescriptorFactory.HUE_RED);
            }
    ...
    public void setCutoutStateAndTranslateFab() {
        ...
        this.materialShapeDrawable.setInterpolation((this.fabAttached && isFabVisibleOrWillBeShown() && this.fabAnchorMode == 1) ? 1.0f : BitmapDescriptorFactory.HUE_RED);
        View viewFindDependentView = findDependentView();
        if (viewFindDependentView != null) {
            ...
            if (viewFindDependentView != null && !ViewCompat.isLaidOut(viewFindDependentView)) {
                ...
                if (viewFindDependentView instanceof FloatingActionButton) {
                    ...
                    if (bottomAppBar.fabAnchorMode == 0 && bottomAppBar.removeEmbeddedFabElevation) {
                        ViewCompat.setElevation(floatingActionButton, BitmapDescriptorFactory.HUE_RED);
