...
public class WrapperSdkExceptionManager {
    ...
    public static UUID saveWrapperException(Thread thread, Throwable th, Exception exception, String str) {
        try {
            UUID uuidSaveUncaughtException = Crashes.getInstance().saveUncaughtException(thread, th, exception);
            if (uuidSaveUncaughtException != null && str != null) {
                sWrapperExceptionDataContainer.put(uuidSaveUncaughtException.toString(), str);
