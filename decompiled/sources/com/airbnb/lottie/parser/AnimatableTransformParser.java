...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of(CmcdData.Factory.OBJECT_TYPE_AUDIO_ONLY, ContextChain.TAG_PRODUCT, CmcdData.Factory.STREAMING_FORMAT_SS, "rz", "r", "o", "so", "eo", "sk", "sa");
    ...
    public static AnimatableTransform parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (animatableFloatValue6.getKeyframes().isEmpty()) {
                animatableFloatValue6.getKeyframes().add(new Keyframe(lottieComposition, Float.valueOf(BitmapDescriptorFactory.HUE_RED), Float.valueOf(BitmapDescriptorFactory.HUE_RED), null, BitmapDescriptorFactory.HUE_RED, Float.valueOf(lottieComposition.getEndFrame())));
            } else {
                if (((Keyframe) animatableFloatValue6.getKeyframes().get(0)).startValue == 0) {
                    z = false;
                    animatableFloatValue6.getKeyframes().set(0, new Keyframe(lottieComposition, Float.valueOf(BitmapDescriptorFactory.HUE_RED), Float.valueOf(BitmapDescriptorFactory.HUE_RED), null, BitmapDescriptorFactory.HUE_RED, Float.valueOf(lottieComposition.getEndFrame())));
                }
                z2 = z;
        ...
        AnimatableValue animatableValue = isPositionIdentity(splitPath) ? null : splitPath;
    ...
    private static boolean isPositionIdentity(AnimatableValue animatableValue) {
        return animatableValue == null || (!(animatableValue instanceof AnimatableSplitDimensionPathValue) && animatableValue.isStatic() && ((PointF) ((Keyframe) animatableValue.getKeyframes().get(0)).startValue).equals(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
    }
