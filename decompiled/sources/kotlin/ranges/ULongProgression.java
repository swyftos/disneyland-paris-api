...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m3365getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM3028constructorimpl = ((int) ULong.m3028constructorimpl(j ^ ULong.m3028constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM3028constructorimpl2 = (iM3028constructorimpl + ((int) ULong.m3028constructorimpl(j2 ^ ULong.m3028constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + iM3028constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m3032toStringimpl(this.first));
            sb.append(CallerDataConverter.DEFAULT_RANGE_DELIMITER);
            sb.append((Object) ULong.m3032toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m3387fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
