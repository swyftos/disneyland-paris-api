    ...
    */
    ...
    public TypeConstructor getTypeConstructor() {
        ...
        if (this.typeConstructor == null) {
            ...
            Collection<KotlinType> collectionMo3432getSupertypes = typeConstructor.mo3432getSupertypes();
            ArrayList arrayList = new ArrayList(collectionMo3432getSupertypes.size());
            Iterator<KotlinType> it = collectionMo3432getSupertypes.iterator();
            while (it.hasNext()) {
    ...
    public ClassDescriptor mo3423getCompanionObjectDescriptor() {
        return this.original.mo3423getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo3424getUnsubstitutedPrimaryConstructor() {
        return this.original.mo3424getUnsubstitutedPrimaryConstructor();
    }
