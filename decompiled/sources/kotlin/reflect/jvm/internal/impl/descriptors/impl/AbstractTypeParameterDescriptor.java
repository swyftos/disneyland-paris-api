...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    protected abstract void mo3434reportSupertypeLoopError(@NotNull KotlinType kotlinType);
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo3432getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo3432getSupertypes();
        if (listMo3432getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo3432getSupertypes;
    }
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo3434reportSupertypeLoopError(kotlinType);
        }
