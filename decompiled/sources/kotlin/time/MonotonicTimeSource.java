...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m3583boximpl(m3577markNowz9LOYto());
    }
    ...
    public long m3577markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m3586constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m3576elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m3575differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m3574adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m3586constructorimpl(LongSaturatedMathKt.m3572saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
